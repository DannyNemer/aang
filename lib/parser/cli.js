...
var commands = {
	...
	logTest: function () {
		// Create file if does not exist, truncates file to zero length if it does exist, or throw an error if `outPath` is a directory.
	...
	rebuild: function () {
		...
		spawnChildProcess('node', [ '../grammar/buildGrammar.js' ])
	},
 ...
 */
function spawnChildProcess(command, args, stdio, callback) {
