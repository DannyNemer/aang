...
/**
 * Converts a linked-list `item` returned returned by `forestSearch()` when ran with `buildDebugTrees` as `true` (which links each `item` to the previous `item` and its new `ruleProps`) to a graph representation.
 *
 * @private
 * @static
