...
exports.general = [
	...
	'my {left-stop-word} repos',
	'my {left-stop-word} JavaScript repos',
	'my JavaScript {left-stop-word} repos',
	'my {left-stop-word} JavaScript {left-stop-word} repos',
	'my {left-stop-word} {left-stop-word} repos',
	'open issues',
	...
	'{left-stop-word} open issues that are never assigned to people who {pre-filter-stop-word} follow me',
	...
	'my followers\' repos',
	'my {left-stop-word} followers\' repos',
	'my {left-stop-word} followers\' {left-stop-word} repos',
	...
	'repos I have not created', // Intentionally wrong, because it implies they can be created
	'repos Danny has not created',
	'repos I made',
	...
	'repos Danny did not fork',
	'repos Danny has not forked',
	'people who do not contribute to my repos',
