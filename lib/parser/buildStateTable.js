/**
 * Initializes the grammar rules and semantics in 'aang.json', and instantiate the `StateTable` for `Parser`.
 *
...
module.exports = (function () {
	...
	var ruleSets = inputFile.ruleSets
	...
	Object.keys(ruleSets).forEach(function (sym) {
		ruleSets[sym].forEach(function (rule) {
	...
	return new StateTable(ruleSets, inputFile.startSymbol)
}())