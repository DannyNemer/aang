/**
 * Initializes the grammar rules and semantics in 'grammar.json', and instantiate the `StateTable` for `Parser`.
 *
...
module.exports = (function () {
	...
	return new StateTable(ruleSets, grammar.startSymbol)
}())