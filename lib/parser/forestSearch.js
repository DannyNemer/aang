...
function createPath(prevPath, sub, ruleProps) {
	...
	if (sub.node.subs) {
		...
		newPath.semantics = appendSemantic(prevPath.semantics, prevPath.nextNodesCount, ruleProps.semantic, ruleProps.semanticIsRHS, ruleProps.insertedSemantic)
 ...
 */
function appendSemantic(prevSemantic, prevNextNodesCount, newSemantic, semanticIsRHS, insertedSemantic) {
	// If `insertedSemantic` exists, then it is a RHS semantic and `newSemantic` also exists and is a LHS semantic.
	if (insertedSemantic) {
