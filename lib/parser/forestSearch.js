 ...
 * @param {number} prevNextNodesCount The number of `nextNodes` in the previous path. Used to determine if the rule of a LHS semantic has been completely reduced and that semantic can be reduced.
