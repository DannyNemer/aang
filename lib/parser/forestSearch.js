 ...
 * @param {number} nextNodesCount The number of nodes in the previous path's `nextNodes` that can produce a semantic. Used to determine if a RHS semantic is complete (no more semantics will follow it) and can be reduced with the preceding LHS semantic.
