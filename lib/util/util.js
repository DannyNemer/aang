...
/**
 * Modifies V8's default stack trace format (when printing) to stylize output and collect 15 stack frames instead of (the default of) 10.
 *
 * @static
 * @memberOf dantil
 * @category Console
...
exports.prettifyStackTrace = function (removePathParens) {
	// Collect 15 stacks frames instead of (the default of) 10.
	Error.stackTraceLimit = 15
