 ...
 * @category Console
 */
exports.logStackFrame = function () {
	getPathAndLineNumberForFrame(function (stack) {
		var topStackFrame = stack[0]
		var funcName = topStackFrame.getFunctionName()
		var pathAndLineNumber = topStackFrame.getFileName() + ':' + topStackFrame.getLineNumber()

		if (!funcName) {
			throw new Error('logStackFrame: Missing function name')
		}

		exports.log(exports.colors.cyan(funcName), '(' + pathAndLineNumber + ')')
	})
}
