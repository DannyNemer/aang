...
/**
 * Gets the file path and line number of `stackFrame` in the format `filePath:lineNumber`.
 *
 * @private
 * @static
 * @param {CallSite} stackFrame The stack frame for which to get the file path and line number.
 * @returns {string} Returns the file path and line number of `stackFrame` in the format `filePath:lineNumber`.
 */
