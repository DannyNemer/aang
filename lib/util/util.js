...
/**
 * Converts `string` to camel case using the [`lodash.camelcase`](https://www.npmjs.com/package/lodash.camelcase) module.
 *
 * @static
 * @memberOf dantil
 * @category String
 ...
 * @example
 *
 * dantil.camelCase('Foo Bar')
 * // => 'fooBar'
 *
 * dantil.camelCase('--foo-bar')
 * // => 'fooBar'
 *
 * dantil.camelCase('__foo_bar__')
 * // => 'fooBar'
 */
exports.camelCase = require('lodash.camelcase')

/**
 * Converts string to kebab case using the [`lodash.kebabcase`](https://www.npmjs.com/package/lodash.kebabcase) module.
 *
 * @static
 * @memberOf dantil
 * @category String
 ...
 * @example
 *
 * dantil.kebabCase('Foo Bar')
 * // => 'foo-bar'
 *
 * dantil.kebabCase('fooBar')
 * // => 'foo-bar'
 *
 * dantil.kebabCase('__foo_bar__')
 * // => 'foo-bar'
 */
exports.kebabCase = require('lodash.kebabCase')