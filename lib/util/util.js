...
/**
 * Passes a structured stack trace as an `Array` of `CallSite` objects to the provided `getFrameFunc(stack)`, which returns a single frame from the `Array`. Returns the file path and line number of the returned frame in the format `filePath:lineNumber`.
 *
