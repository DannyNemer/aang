...
exports.getModuleCallerLocation = function () {
	...
	for (var f = 0, stackLen = stack.length; f < stackLen; ++f) {
		...
		if (thisModuleName !== frameFileName) {
...
exports.logLine = function (label) {
	...
	// If neither `label` is provided nor the invoking function's name is available (because invoked within an anonymous function), then prepend with the next function name in the stack.
