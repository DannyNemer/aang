...
/**
 * Passes a structured stack trace as an array of `CallSite` objects to the provided `getFrameFunc(stack)`, which returns a single frame, for which this function returns in the format `filePath:lineNumber`.
 *
