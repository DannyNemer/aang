 ...
 * The contents of `foo.js`:
 * ```js
 * dantil.logWarningAndPath('Missing property:', obj)
 * // => Prints: Warning: Missing property:
 * //              { property: undefined }
 * //              /Users/Danny/foo.js:1
 */
...
function logColoredLabelAndPath(label, color, logThisLine) {
	// Check `logThisLine` equality strictly to avoid checking truthiness of the following arguments.
	var stackLine = logThisLine === true ? exports.getPathAndLineNumber() : exports.getModuleCallerPathAndLineNumber()
	...
	if (args.length > 0) {
		...
		logWithColoredLabel(label, color, stackLine)
	}
}
 ...
 * @memberOf dantil
 * @category Console
 * @param {boolean} [removePathParens] Specify removing parentheses that surround file paths. This enables iTerm's open-file-path shortcut which the parentheses break in iTerm versions prior to v3.x.
 * @example
 *
