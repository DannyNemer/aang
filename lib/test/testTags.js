...
module.exports = {
	'start-sym-fail': {
		description: 'Indicates the parse initially fails to reach the start symbol, which requires reparsing with all input tokens marked as deletable. The second parse may also fail.',
		appliesToTest: function (test, parseResults) {
			return parseResults.failedInitStartSym
		},
	},
	'no-legal-trees': {
		description: 'Indicates the parse initially fails to generate any legal parse trees (after reaching the start symbol) due to illegal semantics, which requires reparsing with all input tokens marked as deletable. The second parse may also fail.',
		appliesToTest: function (test, parseResults) {
			return parseResults.failedInitLegalTrees
		},
	},
	'reparse': {
		description: 'Indicates the parse requires reparsing with all input tokens marked as deletable. Hence, the union of tags \'start-sym-fail\' and \'no-legal-trees\'.',
		appliesToTest: function (test, parseResults) {
