...
module.exports = {
	'start-sym-fail': {
		description: 'Indicates the parse initially fails to reach the start symbol, which requires marking all input tokens as deletable and re-parsing. The second parse may also fail.',
		appliesToTest: function (test, parseResults) {
			return parseResults.failedInitStartSym
		},
	},
	'no-legal-trees': {
		description: 'Indicates the parse initially fails to generate any legal parse trees (after reaching the start symbol) due to illegal semantics, which requires marking all input tokens as deletable and re-parsing. The second parse may also fail.',
		appliesToTest: function (test, parseResults) {
