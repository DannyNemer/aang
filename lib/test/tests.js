 ...
 *
 * If `test.correction` is `false`, then check that the parse's first result's display text is distinguishable from `test.query`. Else, check that the parse's first result's display text is identical to `test.query`.
 *
 * @type Object[]
 */
module.exports = [
