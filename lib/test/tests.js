 ...
 *
 * If `test.exactMatch` is `true`, then check that the parse's first result's display text is identical to `test.query`. Else, check that the parse's first result's display text is different from `test.query` (i.e., parse edits occurred).
 *
 * @type Object[]
 */
module.exports = [
