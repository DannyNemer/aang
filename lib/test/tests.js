...
module.exports = [
	{
		...
		correction: false,
		semantic: 'intersect(repositories-liked(me),repositories-liked(followers(me)),repositories-liked(repository-likers(intersect(repositories-language(17),repositories-liked(me),repositories-liked(followers(me))))))',
	}, {
		query: 'my repos that are JavaScript repos',
		correction: false,
		semantic: 'intersect(repositories-created(me),repositories-language(17))',
	}, {
		...
		correction: false,
		semantic: 'repositories-language(17)',
	}, {
		...
		correction: false,
		semantic: 'intersect(repositories-language(17),repositories-liked(me),repositories-liked(followers(me)))',
	}, {
		...
		correction: false,
		semantic: 'repositories-created(followers(2))',
	}, {
		...
		correction: false,
		semantic: 'intersect(followers(2),users-gender(male))',
	}, {
		...
		correction: false,
		semantic: 'repos I contributed to',
	}, {
		...
		correction: false,
		semantic: 'intersect(issues-mentioned(followers(repository-likers(repositories-contributed(repository-creators(3))))),issues-opened(me))',
	}, {
		...
		correction: false,
		semantic: 'intersect(issues-mentioned(followers(intersect(repository-likers(repositories-contributed(repository-creators(3))),users-assigned(not(pull-requests-mentioned(me)))))),issues-opened(me))',
	}, {
		...
		correction: false,
		semantic: 'repositories-created(not(repository-likers(repositories-created(2))))',
	}, {
		...
		correction: false,
		semantic: 'not(repositories-language(17))',
	}, {
		...
		semantic: 'repos Danny do not creates',
	}, {
		// Incorrect because implies the returned repos can be created in the futrue.
		...
		correction: false,
		semantic: 'followers who do not follow me',
	}, {
		query: 'people who forked Node',
		correction: false,
		semantic: 'repository-forkers(3)',
	}, {
		...
		// should it only be "has not forked". Should we restrict did to things that can never be done, and have to things that can be done?
		...
		// might not be "and" that is inserted
		...
		// might not be "that are" that is inserted
