...
var willOutput = !argv.q || argv.b || argv.a || argv.s || argv.f || argv.g
 ...
 * @param {string} [test.description] The optional description regarding the test, printed when the test fails.
