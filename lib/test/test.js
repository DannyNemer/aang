 ...
 *   -n, --print-tree-node-costs    Include in parse trees echo node's path cost.             [boolean]
...
var argv = yargs
	...
	.options({
		...
		'n': {
			...
			description: 'Include in parse trees echo node\'s path cost.',
			type: 'boolean',
		},
		's': {
			alias: 'print-stack',
...
var printParseResults = require('../parser/printParseResults.js')
