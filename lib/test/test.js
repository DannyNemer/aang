/**
 * A command line application that parses the suite of test queries and checks that output conforms to the test's specifications.
 *
 ...
 *
 * Description: Parse the suite of test queries and check output conforms to the test's
 * specifications.
 *
 * Options:
 ...
 *                          parse results.
 *   node test --no-output  Finds the 50-best parse trees of each query in the test suite, but
 *                          does not print the parse results.
 */
...
var argv = yargs
	.usage(
		...
		'Description: Parse the suite of test queries and check output conforms to the test\'s specifications.'
	)
	.options({
		'k': {
