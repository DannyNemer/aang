 ...
 *   -q, --quiet                    Suppress parse results and warnings from output.          [boolean]
...
var argv = yargs
	...
	.options({
		...
		'q': {
			alias: 'quiet',
			description: 'Suppress parse results and warnings from output.',
			type: 'boolean',
		},
		'm': {
			alias: 'mute',
...
function parseTest(test) {
	...
	var parseResults = parser.parse(test.query, argv.k, {
		quiet: argv.quiet || argv.benchmark,
