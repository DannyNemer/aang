 ...
 *
 * Description: Benchmark the duration of parsing <query> and finding the 50-best
 * parse trees, and send the measurement to the parent process.
 *
 * Options:
...
var argv = require('yargs')
	.usage(
		...
		'Description: Benchmark the duration of parsing <query> and finding the 50-best parse trees, and send the measurement to the parent process.'
	)
