...
saveTestSuiteChanges(testsOverwritten, testsFilePath, tests)
 ...
 *
 * Defines module variable `testsOverwritten` as `true`.
 *
 * @private
 * @static
 ...
 * @private
 * @static
 * @param {boolean} testsOverwritten Specify changes have been made to `tests`, else prints warning.
 ...
 */
function saveTestSuiteChanges(testsOverwritten, testsFilePath, tests) {
	if (testsOverwritten) {
		// Save new test suite.
