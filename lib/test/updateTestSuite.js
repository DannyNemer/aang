...
function updateTags(test, trees) {
	...
	updateTag(test, trees, existingTags, 'start-sym-fail', testTagsUtil.didFailInitStartSym)

	// Add/remove 'no-legal-trees' tag.
	updateTag(test, trees, existingTags, 'no-legal-trees', testTagsUtil.didFailInitLegalTrees)
