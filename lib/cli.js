 ...
 *
 * Description:
 *   A command line interface for aang.
 *
 ...
 *
 *   Enables configuration within the CLI session of many options for executing the
 *   above programs.
 *
 *   Each program is spawn as a child process. This enables the modules to reload
 *   any changes after every input, and improves benchmark result consistency by
...
require('yargs')
	.usage(
		...
		'   • printStateTable - Prints the state table generated from the grammar.\n\n' +
		'  Enables configuration within the CLI session of many options for executing the above programs.\n\n' +
		'  Each program is spawn as a child process. This enables the modules to reload any changes after every input, and improves benchmark result consistency by mitigating the impact of process caches.'
	)
