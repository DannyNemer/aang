...
/**
 * Checks parse result output by `pfsearch`, `tree`, for errors. Throws an exception if found.
 *
 ...
 * @param {Object|undefined} nextTree The next parse tree in the results, if any (to check result sorting).
