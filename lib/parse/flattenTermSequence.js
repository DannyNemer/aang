...
function createTermSequenceInsertionRuleProps(subnode, cost) {
	...
	// Get the display text `childSub` produces, and conjugate with the grammatical properties specific to its RHS index, if any: `subnodeRuleProps.gramProps[0]`, or `subnodeRuleProps.personNumber` if `subnodeRuleProps.insertedSymIdx` is 0.
	var parentGramProps = subnodeRuleProps.gramProps
