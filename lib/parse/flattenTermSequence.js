...
function createTermSequenceInsertionRuleProps(subnode, cost) {
	 ...
	 * • If `subnodeRuleProps.gramProps[0].form` exists:
	 *   rhs: [ `[create]` ],
	 *   gramProps: { 0: { form: "past" } },
	 *     => "created"
	 *
	 * • Else if `subnodeRuleProps.gramProps[0].acceptedTense` and input tense, `childSub.ruleProps.tense`, exists:
	 *   rhs: [ `[like]` ],
	 *   gramProps: { 0: { acceptedTense: "past" } },
	 *   childSub.ruleProps.tense: "past",
	 *     => "liked"
	 *
	 * • Else if `subnodeRuleProps.insertedSymIdx` is 0 and `subnodeRuleProps.personNumber` exists:
	 *   rhs: [ `[have]` ],
	 *   insertedSymIdx: 0,
	 *   personNumber: "oneSg",
	 *     => "have"
