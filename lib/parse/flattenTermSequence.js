...
function createPartialTermSequenceRuleProps(subnode, cost) {
	 ...
	 * • rhsTermSequenceIndexes - No longer specify `subnode` is a partial term sequence. Necessary when reparsing (with all tokens marked deletable after the intial parse fails) to prevent `calcHeuristicCosts` from attempting to flatten the already flattened partial term sequence subnode.
	 */
	return {
