...
function createRuleProps(rule) {
	...
	if (!rule.isTerminal) {
		 ...
		 * 2. `[contribute-verb]` -> 'contributed', text: { ...verb-forms... }
		 ...
		 */
			...
			/**
			 * If the nonterminal binary term set has `text`, then it is a multi-token substitution. This instructs `calcHeuristicCosts` to use this rule's `text` property instead of the matched terminal rules it produces. For example:
