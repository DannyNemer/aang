...
StateTable.prototype.generate = function (startSym) {
	...
	this.cacheRulePropsArraysMinCost()
}
 ...
 * @memberOf StateTable
 */
StateTable.prototype.cacheRulePropsArraysMinCost = function () {
	for (var nontermSym in this.nonterminalSymTab) {
		var rules = this.nonterminalSymTab[nontermSym].rules
