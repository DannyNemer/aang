...
StateTable.prototype.generate = function (startSym) {
	...
	// Assign `cost` to `ruleProps` array (i.e., insertions) of its first element (which is the cheapest `ruleProps` because it is sorted in grammar generation) for use as its minimum cost in `calcHeuristicCosts`.
