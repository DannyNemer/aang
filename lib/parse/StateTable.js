...
function StateTable(ruleSets, startSymbol) {
	...
	// Remove symbols from `symbolTab` and properties from symbols not needed for parsing.
	this.cleanSymbolTab()
}
...
/**
 * Removes symbols from `symbolTab` and properties from symbols only needed for for `StateTable` generation and not needed for parsing.
 *
 * @memberOf StateTable
 */
StateTable.prototype.cleanSymbolTab = function () {
