...
/**
 * The `StateTable` constructor, which generates a shift-reduce parse table from the input grammar, `ruleSets`.
 *
 * @constructor
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 * @param {string} startSymbolName The name of the start symbol of `ruleSets`.
 * @param {string} blankSymbolName The name of the blank terminal symbol of `ruleSets`.
 */
function StateTable(ruleSets, startSymbolName, blankSymbolName) {
	...
	this.generate(this.lookUp(startSymbolName))
	...
	this.blankWordNodeArray = this.createBlankInsertedNodeArray(blankSymbolName)
}
