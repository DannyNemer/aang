 ...
 * @param {number} pathCount The number of paths created in `pfsearch`. (If `noLegalTrees` is `true`, includes the number of paths created in the first parse forest search.)
 * @param {number} ambiguousTreeCount The number of ambiguous parse trees discarded in `pfsearch`.
 *
 * @static
