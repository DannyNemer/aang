...
function createPath(prevPath, sub, ruleProps) {
	...
	// Prepend `ruleProps.personNumber` to `prevPath.personNumberList` to conjugate instances conjugative display text for verbs within this subtree that follow `prevPath`.
	if (ruleProps.personNumber) {
		...
		newPath.personNumberList = {
			// The person-number property to conjugate display text for verbs that follow `prevPath`.
