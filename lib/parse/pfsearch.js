...
function createPath(prevPath, sub, ruleProps) {
	...
	// Prepend `ruleProps.personNumber` to `prevPath.personNumberList` which conjugates instances of conjugative display text for verbs within the subtree of `prevPath`.
...
/**
 * Prepends `newPersonNumber` to `prevPath.personNumberList` which conjugates instances of conjugative display text for verbs within the subtree of `prevPath`.
 *
 * @private
 * @static
...
function prependPersonNumber(prevPath, newPersonNumber) {
	...
	return {
		// The person-number property to conjugate display text for verbs within the subtree of `prevPath`.
