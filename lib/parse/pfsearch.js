...
/**
 * The `Array` of `k`-best parse trees generated by `pfsearch`, extended with search statistics properties.
 *
 * @typedef ParseTreesArray
 * @type {Object[]}
 * @property {number} pathCount The number of paths created in `pfsearch`. (If `noLegalTrees` is `true`, includes the number of paths created in the first `pfsearch` invocation.)
 ...
 * @returns {ParseTreesArray} Returns the `k`-best parse trees.
 */
