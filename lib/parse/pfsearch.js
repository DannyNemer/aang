 ...
 * @param {boolean} [options.printStats=false] Specify printing performance statistics.
 * @param {boolean} [options.printAmbiguity=false] Specify printing instances of semantic ambiguity.
 * @param {boolean} [options.returnPathCount=false] Specify including the number of paths created with the returned parse trees, returned as an object with properties `trees` and `pathCount`.
