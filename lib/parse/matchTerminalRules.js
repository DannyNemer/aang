...
/**
 * After failing to reach the start node or generate legal parse trees on the initial parse, adds deletables to `deletions` for every token that `Parser.prototype.deletablesLookup()` did not previously mark as deletable.
 *
