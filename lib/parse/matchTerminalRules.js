 ...
 *
 * @memberOf Parser
 * @param {boolean} [onlyNew] Specify this invocation is after failing the initial parse, and to only add nodes using the new deletables.
 */
 ...
 * @param {boolean} [onlyNew] Specify this invocation is after failing the initial parse, and to mark entities added to `entityTab` as `new` (for use by `Parser.prototype.mergeEntityMatches()`).
 */
