 ...
 * @memberOf Parser
 */
Parser.prototype.addWordTabDeletions = function (startIdx) {
	...
	for (var endIdx = (startIdx || 0); endIdx < this.tokensLen; ++endIdx) {
	...
	for (var endIdx = (startIdx || 0); endIdx < (startIdx ? startIdx + 1 : this.tokensLen); ++endIdx) {
		var words = this.wordTab[endIdx]
