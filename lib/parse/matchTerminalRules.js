 ...
 * @memberOf Parser
 */
Parser.prototype.addDeletions = function () {
	...
	for (var curIdx = 0; curIdx < this.tokensLen; ++curIdx) {
		...
		while (deletion = this.deletions[--delStartIdx]) {
			...
			this.addDeleltionToAdjacentSymbolMatches(delStartIdx, curIdx, deletionCost)
		}
		...
		if ((deletion = this.deletions[curIdx + 1]) && curIdx + deletion.length === lastIdx) {
			...
			do {
				...
				this.addDeleltionToAdjacentSymbolMatches(delStartIdx, lastIdx, deletionCost)
			} while (deletion = this.deletions[--delStartIdx])
		}
	}
}
 ...
 */
Parser.prototype.addDeleltionToAdjacentSymbolMatches = function (delStartIdx, delEndIdx, deletionCost) {
