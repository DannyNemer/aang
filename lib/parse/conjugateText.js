...
function conjugateTextObject(textObj, personNumberList, gramProps, inputTense) {
	if (gramProps) {
		 ...
		 *
		 * Perform `gramProps.acceptedTense` conjugation before `gramProps.form` to support subject verb rules that have both properties. For example: "people who like/liked ...".
		 */
