...
module.exports = function conjugateText(text, personNumberList, parentGramProps, inputTense) {
	...
	// Conjugate `text`, which is an array of text strings and conjugative text objects. Exists for insertions and merged `text` values for adjacent terminal rule sets. This array will never contains nested arrays.
	var conjugatedText = ''
