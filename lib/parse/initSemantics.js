...
/**
 * Initializes the semantics of rules in `grammar` for parsing by replacing identical semantic functions, semantic nodes, and semantic arrays with references to a single object. The former enables comparing semantics by reference instead of checking their `name` properties. The latter two enables comparing entire semantic trees and arrays by reference instead of having to traverse the objects.
 *
...
module.exports = function (grammar) {
	...
	var semanticNames = Object.keys(semantics)
	for (var s = 0, semanticNamesLen = semanticNames.length; s < semanticNamesLen; ++s) {
