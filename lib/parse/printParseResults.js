...
module.exports = function (parseResults, options) {
	...
	for (var t = 0, treesLen = trees.length; t < treesLen; ++t) {
		...
		// Print `tree`.
		printParseResult(tree, t, options)
	}
}

/**
 * Prints `tree` (output by `Parser`).
 *
 * @param {Object} tree The parse tree to print.
 * @param {number} treeIdx The index of `tree` within its set (returned by `Parser`).
 * @param {Object} options The options object.
 */
function printParseResult(tree, treeIdx, options) {
