 ...
 * @param {string} [options.diffInputQuery] The input query that produced `trees`, with which to stylize its differences with the top parse result's display text.
 */
