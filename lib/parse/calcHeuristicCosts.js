...
function createBinaryTermSetRuleProps(subNode, cost) {
	...
	if (subNodeRuleProps.insertedSymIdx !== undefined) {
		util.logError('`createBinaryTermSetRuleProps()` invoked on subnode with `insertedSymIdx` (should use `createBinaryTermSetInsertionRuleProps()`):', subNode)
		throw new Error('Ill-formed binary term set')
	}
...
function createBinaryTermSetSubstitutionRuleProps(subNode, cost) {
	...
	if (subNodeRuleProps.insertedSymIdx !== undefined) {
		util.logError('`createBinaryTermSetSubstitutionRuleProps()` invoked on subnode with `insertedSymIdx` (should use `createBinaryTermSetInsertionRuleProps()`):', subNode)
		throw new Error('Ill-formed binary term set')
	}
