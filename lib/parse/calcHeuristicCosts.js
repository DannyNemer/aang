...
function createTermSetSeqRuleProps(subNode, cost) {
	...
	if (!subNodeRuleProps.isTermSetSequence) {
		util.logError('`createTermSetSeqRuleProps()` invoked on subnode not defined as a binary term set:', subNode)
...
function createTermSetSeqSubstitutionRuleProps(subNode, cost) {
	var subNodeRuleProps = subNode.ruleProps
	if (!subNodeRuleProps.isTermSetSequence) {
		util.logError('`createTermSetSeqSubstitutionRuleProps()` invoked on subnode not defined as a binary term set:', subNode)
		throw new Error('Ill-formed binary term set')
	}
...
function createTermSetSeqInsertionRuleProps(subNode, cost) {
	var subNodeRuleProps = subNode.ruleProps
	if (!subNodeRuleProps.isTermSetSequence) {
		util.logError('`createTermSetSeqInsertionRuleProps()` invoked on subnode not defined as a binary term set:', subNode)
		throw new Error('Ill-formed binary term set')
	}
