...
function createTermSetSeqRuleProps(subNode, cost) {
	...
	if (!subNodeRuleProps.isTermSequence) {
		util.logError('`createTermSetSeqRuleProps()` invoked on subnode without `isTermSequence`:', subNode)
...
function createTermSetSeqSubstitutionRuleProps(subNode, cost) {
	var subNodeRuleProps = subNode.ruleProps
	if (!subNodeRuleProps.isTermSequence) {
		util.logError('`createTermSetSeqSubstitutionRuleProps()` invoked on subnode without `isTermSequence`:', subNode)
...
function createTermSetSeqInsertionRuleProps(subNode, cost) {
	var subNodeRuleProps = subNode.ruleProps
	if (!subNodeRuleProps.isTermSequence) {
		util.logError('`createTermSetSeqInsertionRuleProps()` invoked on subnode without `isTermSequence`:', subNode)
