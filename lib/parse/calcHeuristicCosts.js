...
module.exports = function calcMinCost(parentNode) {
	...
	for (var s = 0, childSubsLen = childSubs.length; s < childSubsLen; ++s) {
		 ...
		 * 5. tense - See below.
		 *
		 * The new `ruleProps` excludes the orignal `isTermSequence` property to mark having been flattened.
		 */
...
function createTermSeqRuleProps(subNode, cost) {
	...
	return {
		 ...
		 * The property conjugates nominative verbs within this node's subtree that follow this node.
		 */
