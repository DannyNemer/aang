 ...
 * @type {Object[]}
 * @property {boolean} failedInitStartSym Indicates whether the parse initially failed to reach the start symbol.
...
Parser.prototype.parse = function (query, k, options) {
	// Indicate whether the parse initially failed to reach the start symbol.
