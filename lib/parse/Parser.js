...
Parser.prototype.addSub = function (nontermSym, sub) {
 	...
 	if (nodes) {
 		...
 		// Create array with length of maximum possible `size` value, for use as map of size to nodes for this nonterminal symbol.
 		nodes = this.nodeSets[nontermSym.index] = new Array(this.curIdx || 1)
 	}
