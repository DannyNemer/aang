...
/**
 * The `Array` of `k`-best parse trees generated by `pfsearch`, extended with parse statistics properties.
 *
 * @typedef ParseTreesArray
 * @type {Object[]}
 * @property {boolean} failedStartSym Indicates whether the parse initially failed to reach the start node.
 * @property {boolean} noLegalTrees Indicates whether the parse initially failed to generate any legal parse trees (due to illegal semantics)
 ...
 * @returns {ParseTreesArray|undefined} Returns the `k`-best parse trees if the parse succeeds, else `undefined`.
 */
Parser.prototype.parse = function (query, k, options) {
	// Indicate whether the parse initially failed to reach the start node.
	var failedStartSym = false
	// Indicate whether the parse initially failed to generate any legal parse trees (due to illegal semantics).
