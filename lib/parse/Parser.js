 ...
 * @param {boolean} [options.quiet=false] Specify suppressing parse warnings from output.
 * @param {boolean} [options.buildTrees=false] Specify constructing parse trees in `pfsearch` for printing.
 * @param {boolean} [options.printAmbiguity=false] Specify printing instances of semantic ambiguity in `pfsearch`.
