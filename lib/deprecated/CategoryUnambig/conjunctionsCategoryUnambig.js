...
exports.andWhoNoInsert = g.newBinaryRule({ RHS: [ exports.and, relPronouns.who ], noInsertionIndexes: [ 0, 1 ] })
exports.unionWhoNoInsert = g.newBinaryRule({ RHS: [ exports.union, relPronouns.who ], noInsertionIndexes: [ 0, 1 ] })

// (repos that I like) and/or that (I contribute to)
exports.andThatNoInsert = g.newBinaryRule({ RHS: [ exports.and, relPronouns.that ], noInsertionIndexes: [ 0, 1 ] })
exports.unionThatNoInsert = g.newBinaryRule({ RHS: [ exports.union, relPronouns.that ], noInsertionIndexes: [ 0, 1 ] })
 ...
 */
exports.addForSymbol = function (symbol, noConjunctionInsert) {
