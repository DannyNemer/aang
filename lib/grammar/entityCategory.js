...
// The map of entity category names to definition lines (file-path + line-number); used for error reporting.
exports._defLines = {}
...
exports.new = function (entityCategory) {
	...
	exports._defLines[categoryName] = util.getModuleCallerPathAndLineNumber()
