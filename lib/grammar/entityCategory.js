...
exports.entitySets = {}
// The map of entity category names to creation-lines (file-path + line-number); used for error reporting.
...
exports.new = function (entityCategory) {
	...
	if (exports._creationLines.hasOwnProperty(categoryName)) {
	...
	exports._creationLines[categoryName] = util.getModuleCallerPathAndLineNumber()
