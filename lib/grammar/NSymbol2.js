 ...
 * @param {number} {Object|string|(Object|string)[]} [options.text] The substitution display text used instead of any text `options.rhs` or its ancestors generate.
...
NSymbol.prototype.addNonterminalRule = function (options) {
	 ...
	 */
	assignTermSequence(newNonterminalRule, options)
...
/**
 * Assigns term sequence properties to `newNonterminalRule` using `ruleOptions`. For use by `NSymbol.prototype.addNonterminalRule()`.
 *
 ...
 * @param {Object} ruleOptions The rule options object passed to `NSymbol.prototype.addNonterminalRule()`.
