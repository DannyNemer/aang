...
/**
 * Creates an array of `rhs` indexes for which to prevent `createInsertionRules` from creating insertion rules with those RHS symbols.
 *
 * Looks for `RHSSymbolWrapper` instances in `rhs` with the property `noInsert` defined as `true`.
 *
 * @private
 * @static
