...
/**
 * Creates a nonterminal rule from `options` and appends it to `NSymbol.prototype.rules`.
 *
 * @memberOf NSymbol
...
/**
 * Creates a terminal rule from `options` and appends it to `NSymbol.prototype.rules`.
 *
 * @memberOf NSymbol
 * @param {Object} options The options object.
 * @returns {NSymbol} Returns this `NSymbol` instance.
...
/**
 * Extends, validates, and appends `newRule` to `NSymbol.prototype.rules`.
 *
