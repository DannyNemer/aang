...
var notSemantic
// If not currently building the grammar, then load the `intersect()` and `not()` semantics from the grammar file, which works for comparisons because of `initSemantics`.
...
exports.new = function (options) {
	...
	if (options.name === 'intersect') {
		...
		// Save `insertect()` semantic for use by `semantic.isIllegalRHS()` and `hasSemantic()`.
