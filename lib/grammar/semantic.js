 ...
 *
 * Semantic functions that can serve as antecedents for anaphora have the property `anaphoraPersonNumber`, defined as 'threePl', which indicates the function represents a set of multiple people.
 *
 * @static
 * @memberOf semantic
 * @param {Object[]} semanticNodeArray The semantic node array to inspect.
