 ...
 * @param {Object[]} newLHSSemanticNodeArray The new semantic, yet to be reduced, which will eventually be concatenated with `rhsSemanticNodeArray` and share the same parent semantic.
 * @returns {boolean} Returns `true` if `rhsSemanticNodeArray` contains an instance of `newLHSSemanticNodeArray`'s semantic function of which multiple instances are forbidden, else `false`.
 */
