...
if (require.main.filename !== require.resolve('./buildGrammar')) {
	// Map to `exports.semantics` to enable `semantic.stringToObject()`.
	exports.semantics = require('../grammar.json').semantics

	intersectSemantic = exports.semantics.intersect
	unionSemantic = exports.semantics.union
	notSemantic = exports.semantics.not
}
...
exports.stringToObject = function (semanticString) {
	...
	if (firstLeftParen === -1) {
		return [ {
			...
			semantic: exports.semantics[semanticString] || {
				name: semanticString,
				isArg: true,
			},
		} ]
	...
	var semanticNode = {
		semantic: exports.semantics[semanticString.slice(0, firstLeftParen)],
		children: [],
	}
