 ...
 *
 * It is necessary to prevent contradictory and duplicate semantics, even if explicitly input as such by the user, to prevent such poor semantics as suggestions. In addition, it is to fully simplify the semantics for `pfsearch` to correctly identify semantically identical parse trees (whose logical equivalence would be undetectable in their unsimplified forms).
 *
 * @static
 * @memberOf semantic
