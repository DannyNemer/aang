...
var semanticArgSchema = {
	...
	// The parsing cost.
	cost: { type: Number, required: true },
	// Specify this semantic argument is an anaphor to be replaced by its antecedent semantic.
	anaphoric: Boolean,
	// The person-number with which to resolve anaphora, where this semantic is the antecedent; e.g., "his/her" refers to semantics of third-person-singular representations.
