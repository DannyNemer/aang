...
/**
 * Copies and extends instances of `intersect()` in `semanticNodeArray`, if any, with the property `isComplete` to prevent `reduceUnion()` from incorrectly distributing the LHS semantic that follows the parent `union()` among the arguments of its `intersect()` children, `semanticNodeArray`. If `semanticNodeArray` contains no `intersect()` instances, returns the array unchanged.
 *
