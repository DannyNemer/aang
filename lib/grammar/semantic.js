...
function newSemanticFunc(options) {
	if (util.illFormedOpts(semanticFuncOptionsSchema, options)) {
	...
	var semantic = exports.semantics[options.name] = {
		...
		forbidsMultiple: options.forbidMultiple,
	}
...
function newSemanticArg(options) {
	if (util.illFormedOpts(semanticArgOptionsSchema, options)) {
