...
/**
 * Creates a copy of `semanticNode` extended with the boolean property `isComplete` defined as `true`. For use to mark `intersect()` and `union()` semantics within conjunctions as complete having reached their parent `intersect()` semantic.
 *
 * @private
 * @static
