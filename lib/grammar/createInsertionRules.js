 ...
 * @returns {(Object|string)[]} Returns an array of conjugated strings and yet-to-conjugate text objects (which rely on yet-to-parse person-number properties).
 */
...
function genGramProps(nonInsertedRHSSym, origGramProps) {
	...
	for (var propName in origGramProps) {
		...
		if (gramProp && !isFutileGramProp(newRuleRHS, gramProp)) {
