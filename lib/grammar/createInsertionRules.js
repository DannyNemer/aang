...
function isInsertableRule(insertionSets, rule) {
	 ...
	 *
	 * To allow insertion of this rule if it is binary with one stop sequence, mark the stop sequence RHS symbol as `isOptional` to create a unary rule with just the other RHS symbol.
	 */
