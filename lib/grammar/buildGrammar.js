...
// Remove instances of nonterminal symbols, entity categories, integer symbols, or semantics not used in any grammar rules.
...
g.createEditRules(argv.includeTrees)

// Sort the grammar's components.
g.sortGrammar()

if (!argv.quiet) {
	// Print the number of rules in the grammar.
