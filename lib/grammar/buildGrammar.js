...
// Split the grammar's multi-token terminal symbols into rules that yield only uni-token terminal symbols. This must be invoked before `createEditRules` because it adds instances of `<empty>` to the grammar.
g.splitMutliTokenTerminals()
