...
/**
 * The map of integer terminal symbols names to definition lines (file-path +
...
/**
 * Creates a unique terminal symbol that recognizes integers in input within
 * the specified range.
 *
 * @param {Object} options The options object.
 * @param {number} [options.min=0] The minimum value of integers this symbol
 * can accept.
 * @param {number} [options.max=Number.MAX_SAFE_INTEGER] The maximum value of
 * integers this symbol can accept.
...
exports.new = function (options) {
	...
	// Format the integer symbol name.
...
/**
 * Checks if `options`, which was passed to `intSymbol.new()`, is ill-formed.
...
function isIllFormedIntSymbolOptions(options) {
	// For now, prevent negative integer lower bounds. Enables
	// `matchTerminalRules` to use the absolute value of negative input
	// integers, which would otherwise prevent any matches because negative
	// integers are unlikely to be within any accepted ranges.
	if (options.min < 0) {
