...
var verbSchema = {
	...
	past: String,
	// The inflected terminal symbol for use as the present participle; e.g., "being", "liking". The grammar does not support rules that use this verb form; rather, its definition here only serves to provide a substitution.
