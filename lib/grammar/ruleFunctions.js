 ...
 */
var verbOptsSchema = {
	// Enables creation of edit rules using `Symbol` for this cost by inserting the first terminal symbol for `one`, `pl`, or `oneOrPl` (which ever of those is defined, prioritized in that order).
	insertionCost: { type: Number, optional: true },
