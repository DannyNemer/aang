...
exports.newVerbSet = function (options) {
	...
	options.acceptedVerbTermSets.forEach(function (verbTermSet, i) {
		...
		// If provided, add the terminal rule for the present-subjunctive verb form, substituted when input by `verbSetTextForms`. E.g., "be".
		...
		// If provided, add the terminal rule for the present-participle verb form, substituted when input by `verbSetTextForms`. E.g., "being", "liking".
		...
		// If provided, add the terminal rule for the past-participle verb form, substituted when input by `verbSetTextForm` (and substituted by `past` if the parent rule has matching `acceptedTense`). E.g., "been", "done".
