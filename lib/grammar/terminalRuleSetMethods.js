 ...
 * @param {VerbTermSetSchema[]} [options.substitutedVerbTermSets[]] The verb terminal rule sets substituted when input by the appropriate form in the first verb set in `options.acceptedVerbTermSets`. The parametrization of each form, as opposed to an array of terminal symbols, enforces complete definition of a verb set.
