 ...
 * 3. An ordered pair containing any combination of #1, #2, or nested ordered pairs from which to recursively create new term set sequences with `terminalRuleSetMethods.newTermSequenceBinarySymbol()`.
 *
