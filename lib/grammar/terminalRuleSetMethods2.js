 ...
 * @param {string} [options.tense] Specify the tense, 'present' or 'past', for which to limit the verb terminal rule set; i.e., exclude all verb forms for the opposite tense.
