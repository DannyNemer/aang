...
exports.newTermSetSequence = function (options) {
	...
	options.acceptedTerms.forEach(function (term, i) {
		 ...
		 */
			...
			// If `options.isVerb`, check exclusively `termSetSeqPair[0]` or `termSetSeqPair[1]` is eithera verb terminal rule set or a verb term sequence, else both `termSetSeqPair[0]` and `termSetSeqPair[1]` are neither a verb terminal rule set nor a verb term sequence.
			if (termSetSeqPair[0], termSetSeqPair[1], options.isVerb) {
