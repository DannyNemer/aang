...
exports.newTermSetSequence = function (options) {
	...
	options.acceptedTerms.forEach(function (term, i) {
		...
		if (term.isTermSet || term.isTermSetSequence) {
			// If `options.isVerb`, check `term` is a verb terminal rule set or a verb term set sequence, else `term` is neither a verb terminal rule nor a verb term set sequence.
			if (options.isVerb) {
