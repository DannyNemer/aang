...
exports.newVerbSet2 = function (options) {
	...
	// Assign `verbSetSym.isTermSetSequence` after adding all rules in the verb set to prevent adding more rules `verbSetSym`.
...
exports.newTermSetSequence = function (options) {
	...
	// Assign `termSetSeqSym.isTermSetSequence` after adding all rules in the term set sequence to prevent adding more rules `termSetSeqSym`.
