 ...
 * @property {string} past The simple past-tense verb form (or, preterite), chosen by the parent nonterminal rule property `grammaticalForm` and accepted when input by matching `acceptedTense`. E.g, "was", "liked", "did".
...
exports.newVerb = function (options) {
	...
	// The terminal rule for the simple past-tense verb form (or, preterite), chosen by the parent nonterminal rule property `grammaticalForm` and accepted when input by matching `acceptedTense`. E.g, "was", "liked", "did".
