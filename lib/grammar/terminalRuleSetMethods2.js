	...
	if (options.tense) {
		...
		if (options.tense === 'present') {
			if (verbFormsTermSet.past) {
				util.logErrorAndPath('Present tense verb has forbidden `verbFormsTermSet.past`:', options)
				throw new Error('Ill-formed present tense verb')
			}

			if (verbFormsTermSet.pastParticiple) {
				util.logErrorAndPath('Present tense verb has forbidden `verbFormsTermSet.pastParticiple`:', options)
				throw new Error('Ill-formed present tense verb')
			}
			...
			if (verbFormsTermSet.oneSg) {
				util.logErrorAndPath('Past tense verb has forbidden `verbFormsTermSet.oneSg`:', options)
				throw new Error('Ill-formed past tense verb')
			}

			if (verbFormsTermSet.threeSg) {
				util.logErrorAndPath('Past tense verb has forbidden `verbFormsTermSet.threeSg`:', options)
				throw new Error('Ill-formed past tense verb')
			}

			if (verbFormsTermSet.pl) {
				util.logErrorAndPath('Past tense verb has forbidden `verbFormsTermSet.pl`:', options)
				throw new Error('Ill-formed past tense verb')
			}

			if (verbFormsTermSet.presentSubjunctive) {
				util.logErrorAndPath('Past tense verb has forbidden `verbFormsTermSet.presentSubjunctive`:', options)
				throw new Error('Ill-formed past tense verb')
			}

			if (verbFormsTermSet.presentParticiple) {
				util.logErrorAndPath('Past tense verb has forbidden `verbFormsTermSet.presentParticiple`:', options)
				throw new Error('Ill-formed past tense verb')
			}
