 ...
 * • If `options.verbTense` is defined, checks every verb is of matching grammatical tense.
 *
 * The returned `NSymbol` has the following properties:
 * 1. `name` - `options.symbolName`.
 ...
 * • If `options.isVerb` is falsey, checks every term sequence contains zero verb terminal rule sets.
 * • If `options.verbTense` is defined, checks every verb `options.termPair` produces is of matching grammatical tense.
 *
