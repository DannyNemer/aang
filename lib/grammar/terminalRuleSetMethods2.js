...
/**
 * The present tense inflections of a verb, from which `terminalRuleSetMethods.newVerb(options)`, with `options.tense` as 'present', creates a verb terminal rule set.
 *
 * Inherits properties from `verbFormsTermSetSchema`, excluding the following verb forms:
