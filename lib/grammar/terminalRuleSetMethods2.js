 ...
 * @param {number} [options.insertionCost] The insertion cost for the terminal rule set, assigned to the first rule in the set (i.e., `verbFormsTermSet.oneSg`). Enables the creation of insertion rules using the symbol that produces this set.
 ...
 * @param {Object} options The `terminalRuleSetMethods.newVerb()` options object.
 * @param {string} options.symbolName The name for the new `NSymbol`.
 * @param {number} [options.insertionCost] The insertion cost for the terminal rule set, assigned to the first rule in the set (i.e., `verbFormsTermSet.past`). Enables the creation of insertion rules using the symbol that produces this set.
 ...
 * 3. An ordered pair containing any combination of #2, #3, or nested ordered pairs from which to recursively create new term sequences.
 *
 ...
 * @param {(string|NSymbol|NSymbol[])[]} [options.substitutedTerms] The terminal symbols, term sets, and term sequences to substitute when input with the first item in `options.acceptedTErms`, parameterized as described above.
...
var termSequenceSchema = {
	...
	substitutedTerms: { type: Array, arrayType: [ String, NSymbol, Array ] },
}
