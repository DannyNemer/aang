 ...
 * • `name` - `options.symbolName`.
 * • `isTermSet` - `true`. Prevents adding more rules to this `NSymbol`.
 * • `termSetType` - 'invariable'.
 * • `defaultText` - The `text` string of the first terminal symbol in `options.acceptedTerms`. For use when nesting this `NSymbol` in a term sequence.
 *
 * @memberOf terminalRuleSetMethods
 * @param {Object} options The options object.
 * @param {string} options.symbolName The name for the new `NSymbol`.
 ...
 *
 * The returned `NSymbol` has the following properties:
 * • `name` - The concatenation of the names of the `NSymbol` instances in `options.termPair` (after flattening nested ordered pairs).
 * • `isTermSequence` - `true`. Prevents adding more rules to this `NSymbol`.
