 ...
 * • I.e., created by `terminalRuleSetMethods.newVerb(options)` with matching `options.tense, or `terminalRuleSetMethods.newTermSequence(options)` with matching `options.verbTense`.
 *
 * @memberOf terminalRuleSetMethods
...
exports.isVerbTerm = function (term, tense) {
	...
	return tense ? term.verbTense === tense : true
}