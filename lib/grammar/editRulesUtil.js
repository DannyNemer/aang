...
exports.addRule = function (ruleSets, newRule, nontermSym, stopAmbiguity) {
	...
	if (newRule.isTransposition || !semanticChecks.ruleMissingReducedSemantic(ruleSets, nontermSym, newRule)) {
		// Check `newRule` is unique (i.e., semantically and textually distinguishable from existing rules, which would otherwise yield ambiguity) and below the complexity cost upper bound.
