...
/**
 * Adds a new rule to the grammar if it is unique (i.e., unambiguous), below the cost upper bound, and satisfies any semantic requirement (i.e., has or can produce a reduced semantic if required for itself or its ancestor rules).
 *
 * @static
