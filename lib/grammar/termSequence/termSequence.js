...
exports.newTermSequence = function (options) {
	...
	if (options.substitutedTerms) {
		...
		options.substitutedTerms.forEach(function (term) {
			termSeqSym._addTermSequenceSubstitutedTerm(term, defaultText, options)
		})
	}
...
/**
 * Adds a nonterminal term sequence substitution rule to this `NSymbol` for RHS `term` and `defaultText` as its `text` value.
 *
 ...
 */
NSymbol.prototype._addTermSequenceSubstitutedTerm = function (term, defaultText, options) {
