...
NSymbol.prototype.addTermSequenceSubstitutedTerm = function (term) {
	...
	if (this.isTermSet) {
		util.logErrorAndPath('Attempting to add a substituted term to terminal rule set', util.stylize(this.name) + ':', util.deleteUndefinedObjectProps(term))
		throw new Error('Ill-formed substituted term sequence')
	}

	if (this.termSequenceType === exports.termTypes.STOP) {
		util.logErrorAndPath('Attempting to add a substituted term to', util.stylize(exports.termTypes.STOP), 'sequence', util.stylize(this.name) + ':', util.deleteUndefinedObjectProps(term))
		throw new Error('Ill-formed substituted term sequence')
	}
