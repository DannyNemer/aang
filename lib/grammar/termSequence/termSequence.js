 ...
 * @param {string|NSymbol|NSymbol[]|SubstitutedTerm} term The terminal symbol, terminal rule set, term sequence, or term sequence pair to add as substitute rule to `termSequenceSym`, for use in error messages.
