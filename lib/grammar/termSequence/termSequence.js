 ...
 * 2. A terminal rule set created by `verbTermSet.newVerb()`, `verbTermSet.newTenseVerb()`, `pronounTermSet.newPronoun()`, or `nounTermSet.newNoun()`.
...
exports.newTermSequence = function (options) {
	...
	options.acceptedTerms.forEach(function (term, i) {
		...
		/**
		 * If `term` is a term sequence created by `termSequence.newTermSequence()` or `termSequence.newTermSequenceBinarySymbol()` (or a terminal rule set created by `verbTermSet.newVerb()`, `verbTermSet.newTenseVerb()`, `pronounTermSet.newPronoun()`, or `nounTermSet.newNoun()`).
		 *
 ...
 * 1. A terminal rule set created by `verbTermSet.newVerb()`, `verbTermSet.newTenseVerb()`, `pronounTermSet.newPronoun()`, or `nounTermSet.newNoun()`.
 ...
 * • {Object|string} defaultText - `options.defaultText`.
 ...
 * @param {Object|string} options.defaultText The text used for substitution display text when nesting this symbol in the first accepted rule of a term sequence created with `termSequence.newTermSequence()`.
 ...
 * `termSequence.newNoun(options)` - Creates an `NSymbol` that produces a terminal rule set for a noun.
 *
