 ...
 *
 * Each rule in the set, created from the terms in `options.pronounFormsTermSet`, has the string `option.termSet.pl` as its `text`. The grammar generator and `pfsearch` do not use `options.termSet.sg` as display text. Rather, its parametrization serves only to enforce complete definition of nouns, and is replaced when input by `option.termSet.pl`.
 *
