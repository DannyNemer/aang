...
/**
 * Creates an `NSymbol` that produces a stop term sequence, comprised of terminal rules, terminal rule sets, and nested term sequences, which are deleted (i.e., produce no display text) when matched in input.
 *
 ...
 * @returns {NSymbol} Returns the new `NSymbol` for the stop sequence.
 */
