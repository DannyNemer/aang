...
/**
 * Checks `termSeqPair` is a valid stop sequence pair and recursively flattens any nested ordered pairs to `NSymbol` instances that produce the nested term sequence. If `termSeqPair` is invalid, throws an exception.
 *
 * @private
 * @static
