 ...
 *
 * These methods create an `NSymbol` for verb form term sets, as opposed to adding rules to an existing `NSymbol`, and forbid adding rules to the new `NSymbol` afterward to prevent external changes to the rule sets.
 */
