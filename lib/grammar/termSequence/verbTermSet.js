 ...
 * • defaultText - The conjugative `text` object for the verb forms, used as display text for every (terminal)
 ...
 * @param {number} [options.insertionCost] The insertion cost for the terminal rule set, assigned to the first rule in the set (i.e., `verbFormsTermSet.oneSg`). Enables the creation of insertion rules using the new nonterminal symbol that produces this set.
 ...
 * @param {VerbFormsTermSet} options.verbFormsTermSet The verb terminal symbol set with each verb form.
 ...
 * @param {VerbFormsTermSet|PresentVerbFormsTermSet|PastVerbFormsTermSet} options.verbFormsTermSet The verb terminal symbol set with each verb form.
 ...
 * @param {VerbFormsTermSet|PresentVerbFormsTermSet|PastVerbFormsTermSet} verbFormsTermSet The verb terminal symbol set with each verb form.
