 ...
 *
 * Invoke this function after removing unused rules in `removeNullNonterminalSymbols()`.
 *
 * @private
 * @static
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
...
/**
 * Recursively removes nonterminal symbols with no rules, rules whose RHS symbols include those symbols, and any rule-less nonterminal symbols that result.
 *
 * Invoke this function before `createInsertionRules()`, which would otherwise create insertion rules using the nonterminal rules this removes.
 *
 * @private
 * @static
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 ...
 *
 * Invoke this function after removing rules with rule-less symbols in `removeNullNonterminalSymbols()`.
 *
 * @private
 * @static
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
