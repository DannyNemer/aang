...
/**
 * Checks if `insertion` produces a meaningless clause, which should be avoided. For use by `createInsertionRules()` and `mergeInsertionSets()` to discard such insertions.
 *
