 ...
 *
 * Invoke this module after adding all non-edit rules and after invoking `removeIllFormedRulesAndSyms()` to remove ill-formed nonterminal rules and symbols.
 *
 * @static
...
module.exports = function (ruleSets, includeTrees, stopAmbiguity) {
	...
	// Remove the temporary rules and rule properties used for grammar generation from `ruleSets` to exclude them from the output grammar. Invoke this function at the conclusion of grammar generation.
	removeTempGrammarPropsAndRules(ruleSets, includeTrees)
}
 ...
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 */
function removeTempGrammarPropsAndRules(ruleSets, includeTrees) {
