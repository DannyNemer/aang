 ...
 *
 * Discards insertions that `isSemanticlessClauseInsertion()` determines produce a meaningless clause.
 *
 * @private
 * @static
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 ...
 */
function isSemanticlessClauseInsertion(ruleSets, insertion, insertedRHSSym, nontermSym, origRule, printWarning) {
	/**
