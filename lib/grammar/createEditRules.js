...
module.exports = function (ruleSets, includeTrees) {
	...
	// Recursively remove nonterminal symbols with no rules, rules whose RHS contains those symbols or `<empty>`, and any rule-less nonterminal symbols that result. Called after finding and creating insertions from rules with '<empty>' in `findTermRuleInsertions()`.
...
/**
 * Recursively removes nonterminal symbols with no rules, rules whose RHS contains those symbols or `<empty>`, and any rule-less nonterminal symbols that result. Called after finding and creating insertions from rules with '<empty>' in `findTermRuleInsertions()`.
 *
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 */
