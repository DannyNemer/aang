...
/**
 * Gets a set of insertions created by merging every possible pair of insertions in `insertionsA` and `insertionsB`. For use by `findNonterminalRuleInsertions()` when creating an insertion from a binary rule, when both RHS symbols have insertions.
 *
 * @private
 * @static
 * @param {Object[]} insertionsA The set of insertions to merge.
 * @param {Object[]} insertionsB The other set of insertions to merge.
 * @returns {Object[]} Returns a set of insertions created by merging every possible pair of insertions in `insertionsA` and `insertionsB`.
 */
function mergeInsertions(insertionsA, insertionsB) {
