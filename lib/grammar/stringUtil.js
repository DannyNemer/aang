...
/**
 * Converts the name of a new grammar element to lowercase, removes any characters the grammar reserves for special purpose (e.g., brackets in `Symbol.prototype.name`), and checks for whitespace.
 *
 * @static
 * @memberOf stringUtil
