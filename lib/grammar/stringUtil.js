...
/**
 * Determines if a name of a grammar element contains reserved characters. If `true`, prints an error indicating the reserved character. The following characters are reserved:
