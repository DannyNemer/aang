 ...
 *
 * `createEditRules` invokes this method after removing ill-formed nonterminal symbols and rules in `removeIllFormedRulesAndSyms()`, and before adding edit-rules which inherit the semantic properties of their original (non-edit) rules.
 *
 * @static
 * @memberOf semanticPotential
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
