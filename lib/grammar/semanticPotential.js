 ...
 * 2. Is a placeholder that generates a reduced semantic argument from input; e.g., entity, integer.
...
exports.ruleHasSemantic = function (rule) {
	...
	// A placeholder that generates a reduced semantic argument from input; e.g., entity, integer.
	// - Skip `<empty>`.
