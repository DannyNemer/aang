...
/**
 * Finds and logs instances of nonterminal symbols, entity categories, integer symbols, or semantic functions and arguments not used in any rules in `ruleSets`. Removes each unused component from its associated data set.
 *
