...
/**
 * Checks if `semanticChecks.symCanProduceSemantic()` returns truthy for any symbol in `rule.rhs`. Stops iteration once `semanticChecks.symCanProduceSemantic()` returns truthy.
 *
 * @static
 * @memberOf semanticChecks
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 * @param {Object} rule The rule with the RHS symbols to check.
