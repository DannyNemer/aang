 ...
 * @param {boolean} [suppressWarnings] Specify suppressing warnings for rules that can not produce a required reduced semantic.
 ...
 * @param {boolean} [suppressWarnings] Specify suppressing warnings if `rule` (or ancestor rules) can not produce a required reduced semantic.
 * @param {boolean} [printFailedPaths] If `suppressWarnings` is falsey and `rule` (or ancestor rules) can not produce a reduced semantic, specify printing graph representations of the parse tree paths that require `rule` (or ancestor rules) to produce a reduced semantic.
 ...
 * @param {Object} rule The rule `nontermSym` produces to check.
 * @param {boolean} [suppressWarnings] Specify suppressing warnings, in recursive `semanticChecks.ruleMissingReducedSemantic()` invocations, if `rule` (or ancestor rules) can not produce a required reduced semantic.
