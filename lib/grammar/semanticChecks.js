...
/**
 * Removes instances of the rule property, `rule.semanticSafe`, used by `semanticChecks.ruleMissingReducedSemantic()` in `removeIllFormedRulesAndSyms`.
 *
 * Invoke this method at the end of grammar generation, after adding edit-rules, which relies on these properties to discard new edit-rules that can not produce a required reduced semantic.
 *
 * @static
 * @memberOf semanticChecks
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 */
exports.removeSemanticChecksProps = function (ruleSets) {
