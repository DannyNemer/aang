 ...
 * @param {boolean} [printFailedPaths] If `printWarning` is truthy, specify printing graph representations of the parse tree paths that require `rule` to produce a reduced semantic, which it can not produce.
 ...
 * @param {boolean} [printFailedPaths] If `printWarning` is truthy, specify printing, in recursive `semanticChecks.ruleMissingReducedSemantic()` invocations, graph representations of the parse tree paths that require `rule` to produce a reduced semantic, which it can not produce.
