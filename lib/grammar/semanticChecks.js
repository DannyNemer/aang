...
exports.removeRulesMissingRequiredSemantics = function (ruleSets) {
	...
	// If `semanticChecks.ruleMissingReducedSemantic()` removed rules, then remove any rule-less or unreachable nonterminal symbols that result.
	...
	if (initRuleCount !== grammarUtil.getRuleCount(ruleSets)) {
