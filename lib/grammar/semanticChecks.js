 ...
 * @param {boolean} [printWarning] Specify printing a warning if `rule` cannot produce a required semantic.
 * @param {boolean} [printFailedParsePath] If `printWarning` is truthy, specify printing a graph representation of the parse tree path if `rule` cannot produce a required semantic.
 ...
 * @param {Object} rule The rule produced by `nontermSym` to check.
 * @param {boolean} [printWarning] Specify printing a warning, in recursive `semanticChecks.ruleMissingReducedSemantic()` invocations, if `rule` cannot produce a required semantic.
 * @param {boolean} [printFailedParsePath] If `printWarning` is truthy, specify printing, in recursive `semanticChecks.ruleMissingReducedSemantic()` invocations, a graph representation of the parse tree path if `rule` cannot produce a required semantic.
