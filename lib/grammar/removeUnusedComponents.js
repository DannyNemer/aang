...
module.exports = function (ruleSets, supressWarnings) {
	...
	removeUnusedEntityCategories(ruleSets, nontermSyms, supressWarnings)

	// Remove unused integer symbols.
	removeUnusedIntegerSymbols(ruleSets, nontermSyms, supressWarnings)

	// Remove unused semantic functions and arguments.
	removeUnusedSemantics(ruleSets, nontermSyms, supressWarnings)
}
 ...
 * @param {boolean} [supressWarnings] Specify suppressing warnings from output.
 */
function removeUnusedEntityCategories(ruleSets, nontermSyms, supressWarnings) {
 ...
 * @param {boolean} [supressWarnings] Specify suppressing warnings from output.
 */
function removeUnusedIntegerSymbols(ruleSets, nontermSyms, supressWarnings) {
 ...
 * @param {boolean} [supressWarnings] Specify suppressing warnings from output.
 */
function removeUnusedSemantics(ruleSets, nontermSyms, supressWarnings) {
