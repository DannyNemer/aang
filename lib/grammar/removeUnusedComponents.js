...
module.exports = function (ruleSets, supressWarnings) {
	...
	// Remove nonterminal symbols without rules, rules whose RHS symbols include those symbols, and any rule-less or unreachable (via the start symbol) nonterminal symbols that result.
