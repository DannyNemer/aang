...
module.exports = function (ruleSets, suppressWarnings) {
	...
	componentRemoved = removeUnusedEntityCategories(ruleSets, suppressWarnings) || componentRemoved

	// Remove unused integer symbols.
	componentRemoved = removeUnusedIntegerSymbols(ruleSets, suppressWarnings) || componentRemoved

	// Remove unused semantic functions and arguments.
	componentRemoved = removeUnusedSemantics(ruleSets, suppressWarnings) || componentRemoved
 ...
 */
function removeUnusedEntityCategories(ruleSets, suppressWarnings) {
 ...
 */
function removeUnusedIntegerSymbols(ruleSets, suppressWarnings) {
 ...
 */
function removeUnusedSemantics(ruleSets, suppressWarnings) {
