...
module.exports = function (ruleSets, supressWarnings) {
	...
	// Recursively remove nonterminal symbols without rules, rules whose RHS symbols include those symbols, and any rule-less and unreachable (via the start symbol) nonterminal symbols that result.
	removeUnusedNonterminalSyms(ruleSets, supressWarnings)
}
