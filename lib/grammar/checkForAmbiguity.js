var util = require('../util')
  ...
  * @param {boolean} [opts.useTestRules] Specify replacing `ruleSets` with ambiguous test rules.
...
module.exports = function (ruleSets, opts) {
	if (opts === undefined) {
		opts = {}
	...
	// If `opts.useTestRules` is `true`, replace `ruleSets` with ambiguous test rules to check the accuracy of this algorithm.
