...
function createVerbTerminalRule(terminalSymbol, displayText, tense) {
	...
	if (exports.isIllFormedTerminalSymbol(terminalSymbol)) {
...
function isIllFormedNewPronounOptions(options) {
	...
	for (var pronounForm in pronounFormsTermSet) {
		if (exports.isIllFormedTerminalSymbol(pronounFormsTermSet[pronounForm])) {
			return true
		}
	}
...
exports.newTermSequence = function (options) {
	...
	options.acceptedTerms.forEach(function (term, i) {
		...
		if (term.constructor === String) {
			...
			if (exports.isIllFormedTerminalSymbol(term)) {
