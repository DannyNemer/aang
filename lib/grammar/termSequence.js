...
function baseNewVerb(options) {
	...
	var oneSgTermRule = createVerbTerminalRule(verbFormsTermSet.oneSg, displayText, 'present')
...
/**
 * Creates a `NSymbol.prototype.addRule()` options object for `terminalSymbol` with `displayText` as its `text` value and `tense` as its `tense` value.
 *
