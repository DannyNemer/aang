...
/**
 * Extends this symbol with term sequence properties.
 *
...
var toTermSequenceSchema = {
	isTermSet: Boolean,
	type: termSequenceSchema.type,
	defaultText: { type: [ Object, String ], required: true },
	insertionCost: Number,
}

NSymbol.prototype._toTermSequence = function (options) {
	if (util.illFormedOpts(toTermSequenceSchema, options) || isIllFormedToTermSequenceOptions(this, options)) {
		throw new Error('Ill-formed term sequence')
	}
