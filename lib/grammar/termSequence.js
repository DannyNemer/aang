 ...
 * • name - `options.symbolName` if defined, else of the form 'verb-${options.verbFormsTermSet.pl}'. If `options.splitByTense`, '-present' and '-past' are appended to this name for the present and past terminal rule sets, respectively.
