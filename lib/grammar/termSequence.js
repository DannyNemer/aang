...
exports.newTermSequence = function (options) {
	...
	options.acceptedTerms.forEach(function (term, i) {
		 ...
		 */
			...
			var termSeqPair = termSequencePairToSymbol(term, options.type === 'verb', options.verbTense)
...
exports.newTermSequenceBinarySymbol = function (options, _isNestedTermSequence) {
	 ...
	 */
	var termSeqPair = termSequencePairToSymbol(options.termPair, options.isVerb, options.verbTense, _isNestedTermSequence)
 ...
 */
function termSequencePairToSymbol(termSeqPair, isVerb, verbTense, isNestedTermSequence) {
