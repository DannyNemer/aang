 ...
 * @param {Object|string} options.displayText The text used for substitution display text when nesting this symbol in the first accepted rule of a term sequence created with `termSequence.newTermSequence()`.
