...
exports.newTermSequenceBinarySymbol = function (options, _isNestedTermSequence) {
	...
	if (_isSubstitution && !_isNestedTermSequence) {
		util.logError('`_isSubstitution` is `true` when `_isNestedTermSequence` is falsey')
		throw new Error('Ill-formed binary term sequence')
	}
	 ...
	 */
	var termSeqPair = flattenNestedTermSequencePairs(options.termPair, options.type, _isNestedTermSequence, _isSubstitution)
