...
exports.newVerb = function (options) {
	 ...
	 *
	 * Before `pfsearch`, `flattenTermSequence` flattens term sequences to a single terminal parse node with a single display text. If the parse node associated with a root term sequence node can produce multiple parse trees, it is due to ambiguity and the cheapest is chosen, though this rarely occurs.
	 *
