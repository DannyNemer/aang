...
/**
 * Checks if `term` is either a verb terminal rule set (created by `terminalRuleSetMethods.newVerb()`) or a verb term sequence when forbidden. If so, prints an error message.
 *
