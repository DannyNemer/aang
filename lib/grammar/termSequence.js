...
function baseNewVerb(options) {
	 ...
	 *
	 * If `options.splitByTense` is `true` (which specifies splitting `options.verbFormsTermSet` into separate terminal rule sets for grammatical tense), then `verbSym` is a present verb term set and lacks `verbFormsTermSet.past`.
	 */
	if (!options.splitByTense) {
