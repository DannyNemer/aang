	...
	options.acceptedTerms.forEach(function (term, i) {
		 ...
		 */
			...
			if (term.termSequenceType !== options.type) {
				util.logErrorAndPath('Term sequence', util.stylize(term.name), 'of', util.stylize(term.termSequenceType), 'provided to parent term sequence of', util.stylize(options.type), 'type:', options)
				throw new Error('Ill-formed term sequence')
			}
