 ...
 * • `flattenTermSequence` creates a new, terminal `ruleProps` for the rule with the `text` value, which `pfsearch` uses to generate display text. `flattenTermSequence` also always traverses the matched terminal rules to get the input tense of any matched verb terminal rules, which `pfsearch` uses if the parent rule has matching `acceptedTense`.
 *
