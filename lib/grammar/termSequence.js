	...
	for (var t = 0; t < 2; ++t) {
		...
		if (term.termSequenceType !== 'invariable') {
			if (termSequenceType === 'invariable') {
				...
				util.logErrorAndPath('Term in provided term sequence pair neither of (neutral) type', util.stylize('invariable'), ' nor the specified type', util.stylize(termSequenceType) + ':', term, termSeqPair)
				return true
			}
		}
	}
