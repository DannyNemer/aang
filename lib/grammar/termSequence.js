...
/**
 * Creates a terminal rule options object for `terminalSymbol` with `verbTextForms` as its conjugative `text` object, as part of a verb rule set.
 *
 * For use by `baseNewVerb()`.
 *
 * @private
 * @static
 * @param {string} terminalSymbol The terminal symbol without whitespace to match in input.
 * @param {Object} verbTextForms The terminal rule conjugative `text` object with all of a verb's forms.
