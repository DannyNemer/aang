 ...
 * • defaultText - If `options.tense` is 'present' or `undefined`, the conjugative `text` object for the verb forms, else if `options.tense` is 'past', the invariable `text` string for the past tense verb form. This value is identical for every terminal rule this `NSymbol` produces. For use when nesting this `NSymbol` in a term sequence.
