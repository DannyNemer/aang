...
exports.newTermSequence = function (options) {
	...
	options.acceptedTerms.forEach(function (term, i) {
		 ...
		 */
			...
			if (i === 0) {
				/**
				 * Save the `defaultText` of the first item in `options.acceptedTerms` as the display text for `options.substitutedTerms`, if any.
				 * • If `term` is a terminal rule set, `defaultText` is the identical `text` of all terminal rules in the set.
				 * • If `term` is a term sequence, `defaultText` is the display text of its first accepted term sequence it produces.
				 */
