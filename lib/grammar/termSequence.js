 ...
 * @property {string|NSymbol|NSymbol[]} term The terminal symbol, term set, term sequence, or term sequence pair to substitute when matched.
...
function isIllFormedNewTermSequenceOptions(options) {
	if (options.insertionCost !== undefined) {
		...
		if (options.type !== exports.termTypes.INVARIABLE) {
			util.logErrorAndPath('Term sequence with `insertionCost` is not of', util.stylize(exports.termTypes.INVARIABLE), 'type:', options)
			return true
		}
