...
exports.newTermSequence = function (options) {
	...
	options.acceptedTerms.forEach(function (term, i) {
		 ...
		 *
		 * An example of a terminal rule set and a nested ordered pair of two terminal rule sets from which to recursively create a new term sequence:
		 *   `[have-in-common]` -> `[have]`                              -> "have", text: `{have-verb-forms}`
		 ...
		 */
			...
			util.logErrorAndPath('Accepted term is neither a terminal symbol, terminal rule set, term sequence, nor an ordered pair of term sequences:', term, options)
			throw new Error('Ill-formed term sequence')
		}
	})
