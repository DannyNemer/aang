		...
		options.substitutedTerms.forEach(function (term) {
			...
			if (term.constructor === String) {
				...
				if (options.type !== exports.termTypes.INVARIABLE && options.type !== exports.termTypes.PRONOUN) {
					util.logErrorAndPath('Terminal symbol provided as substituted term for term sequence of', util.stylize(options.type), 'type, not of', util.stylize(exports.termTypes.INVARIABLE), 'or', util.stylize(exports.termTypes.PRONOUN), 'type:', term, options)
					throw new Error('Ill-formed substituted term sequence')
				}
...
exports.newTermSequenceBinarySymbol = function (options, _isNestedTermSequence, _isSubstitution) {
