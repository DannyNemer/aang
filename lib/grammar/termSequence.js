...
/**
 * Checks if `options`, which was passed to `terminalRuleSetMethods.newTermSequence()` or `terminalRuleSetMethods.newTermSequenceBinarySymbol()`, is ill-formed. If so, prints an error.
 *
 * @private
 * @static
