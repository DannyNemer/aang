		...
		options.substitutedTerms.forEach(function (term) {
			 ...
			 */
				...
				if (options.type === exports.termTypes.PRONOUN) {
					if (!exports.isTermSequenceType(term, options.type) && !exports.isTermSequenceType(term, exports.termTypes.INVARIABLE)) {
				...
				} else if (!exports.isTermSequenceType(term, options.type)) {
