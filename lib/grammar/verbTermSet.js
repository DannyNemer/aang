...
exports.newVerb = function (options) {
	...
	// Extend `verbSym` with a terminal rule set for every terminal symbol in `verbFormsTermSet`, with `verbDisplayText` as each rule's `text` value.
	addVerbTerminalRuleSet(verbSym, verbFormsTermSet, verbDisplayText, options.insertionCost)
}
