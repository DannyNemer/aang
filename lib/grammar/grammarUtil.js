 ...
 *
 * If both `leftText` and `rightText` are strings, merges the two into a single string separated by a space. Else, at least one is a conjugative object (with different forms of a term), and creates a new ordered pair containing `leftText` and `rightText` (in the order provided as arguments).
 *
 * @private
 * @static
