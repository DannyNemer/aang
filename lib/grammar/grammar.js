...
exports.compileGrammar = function () {
	...
	/**
	 * Check `ruleSets` for errors after constructing all rules and edit-rules.
	 *
	...
	/**
	 * Remove the temporary rules and rule properties used for grammar generation from `ruleSets` to exclude them from the output grammar.
	 *
