 ...
 *
 * `grammar.newTermSequence()` - Creates an `NSymbol` that produces a terminal rule sequence forming a term or phrase, comprised of terminal rule sets (e.g., `g.newVerb()`, `g.newInvariableTerm()`) and nested term sequences.
 *
