...
/**
 * Diversifies the costs of the grammar's non-edit rules by incrementing the cost of each nonterminal symbol's rules by an increasing epsilon value.
 *
...
/**
 * Creates grammar edit-rules derived from insertion and transposition costs, and empty strings in existing rules.
 *
...
/**
 * Checks `ruleSets` for errors after constructing all rules and edit-rules.
 *
