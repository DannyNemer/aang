 ...
 * 1. Converts the grammar's regex-style terminal symbols into rules that yield only uni-token terminal symbols.
...
exports.compileGrammar = function () {
	/**
	 * Convert the grammar's regex-style terminal symbols into rules that yield only uni-token terminal symbols. This is necessary to enable partial matches and deletions within what would otherwise be regex-style terminal symbols.
	 *
