 ...
 *
 * `grammar.newBinaryTermSequence()` - Creates an `NSymbol` with a single binary rule that produces the two provided terms. Together, those symbols produce a terminal sequence forming a phrase comprised of terminal rule sets and nested terminal rule set sequences.
 */
