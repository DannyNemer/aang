...
/**
 * Extend `grammar` with the following methods:
 * `grammar.newVerb()` - Creates an `NSymbol` that produces a terminal rule set for a pronoun with the necessary text forms for conjugation.
 *
 * `grammar.newPronoun()` - Creates an `NSymbol` that produces a terminal rule set for a verb with the necessary text forms for conjugation.
 *
