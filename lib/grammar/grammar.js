 ...
 *
 * `grammar.isVerb()` - Check if an `NSymbol` is a verb created by `grammar.newVerb()` and has inflected text for past tense.
 *
 * `grammar.isPresentVerb()` - Check if an `NSymbol` is a verb created by `grammar.newVerb()` and lacks inflected text for past tense.
 *
