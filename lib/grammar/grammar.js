...
// Creates grammar rules derived from insertion and transposition costs, and empty strings in `NSymbol._ruleSets`.
exports.createEditRules = require('./createEditRules').bind(null, NSymbol._ruleSets)

// Checks if a rule lacks and cannot produce a RHS semantic needed by itself or an ancestor rule in `NSymbol._ruleSets`.
exports.ruleMissingRHSSemantic = require('./ruleMissingRHSSemantic').bind(null, NSymbol._ruleSets)
...
exports.printStats = function (prevOutputFilePath) {
	var newRuleCount = exports.getRuleCount(NSymbol._ruleSets)
	var newEntityCount = exports.getEntityCount(entityCategory._entitySets)
