...
/**
 * Checks if `rule` lacks and cannot produce a RHS semantic required for itself or an ancestor rule in `ruleSets`. If true, returns a graph representation of the parse tree path from the rule requiring the RHS semantic to `rule`.
 *
