 ...
 */
exports.present = createBeVerbTerminalRuleSet({
 ...
 */
exports.past = createBeVerbTerminalRuleSet({
 ...
 *
 * Matches every "be" form of either tense in input, and conjugates to the correct past tense form.
 ...
 */
function createBeVerbTerminalRuleSet(options) {
	...
	var displayText = {
		...
		// "being", "been"
		// For use with the verb compound "have been".
		participle: verbFormsTermSet.participle,
	}
