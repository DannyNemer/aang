 ...
 *
 * Match only the present tense "be" forms in input.
 ...
 *
 * Match only the past tense "be" forms in input.
 ...
 *
 * Match every "be" form in input, which conjugate to the correct form in the matched tense.
...
exports.pastWithSubstitutedPresentForms = g.newSymbol(exports.past.name, 'with', 'substituted', 'present', 'forms').addRule({
	...
	rhs: [ exports.present ],
	// Substitute the present tense terminal symbols with the `past` conjugative `text` object when matched in input.
