 ...
 * @memberOf Category
 * @param {Object} options The options object.
 * @param {NSymbol} options.headTerm The term sequence of type 'invariable' for the subcategory head, created by `g.newTermSequence()` with `type` 'invariable'.
 * @returns {Category} Returns this `Category` instance.
 */
...
function isIllFormedSubcategoryOptions(subcategoryOptions) {
	// Check `subcategoryOptions.headTerm` is a term sequence of type 'invariable'.
	if (isIllFormedTermSequence(subcategoryOptions, 'headTerm', g.termTypes.INVARIABLE)) {
		return true
	}
