...
Category.prototype.addTenseVerbRuleSet = function (options) {
	 ...
	 * 2. A present tense verb sequence created by `g.newTermSequence(termOptions)` where `termOptions.verbTense` is 'present'.
	 */
	 ...
	 * 2. A past tense verb sequence created by `g.newTermSequence(termOptions)` where `termOptions.verbTense` is 'past'.
	 */
