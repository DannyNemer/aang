 ...
 *
 * Demands the verb be two separate terminal rule sets to prevent multiple similar suggestions, scarcely distinguished by tense (though different semantics). For example, this prevents the following:
 *   "companies I work at"
