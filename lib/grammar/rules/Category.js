...
/**
 * Adds the following nonterminal rules to this `Category` for a verb which represents relationships characterized by an action between users and instances of this `Category`:
