...
function Category(options) {
	...
	if (options.possSemantic) {
		this._addPossesssiveRules(options.possSemantic)
	}
 ...
 *
 * This method is only to be invoked once from within the `Category` constructor.
 *
 * @private
 * @memberOf Category
 ...
 */
Category.prototype._addPossesssiveRules = function (possSemantic) {
