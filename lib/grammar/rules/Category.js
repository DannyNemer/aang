 ...
 * @memberOf Category
 * @param {Object} options The options object.
 * @param {NSymbol} options.verbTerm The symbol that produces the terminal rule set for the verb that represents this action, created by `g.newVerb()`.
...
Category.prototype.addVerbRuleSet = function (options) {
	...
	// Check `options.verbTerm` is a verb created by `g.newVerb()` that has inflected text for past tense.
 ...
 * @memberOf Category
 * @param {Object} options The options object.
 * @param {NSymbol} options.verbPresentTerm The symbol that produces the present-tense terminal rule set for the verb that represents this action, created by `g.newVerb()`.
...
Category.prototype.addTenseVerbRuleSet = function (options) {
	...
	// Check `options.verbPresentTerm` is a verb created by `g.newVerb()` that lacks inflected text for past tense.
 ...
 * @param {NSymbol} [options.verbTerm] The symbol that produces the terminal rule set for the action associated with the item count, created by `g.newVerb()`.
