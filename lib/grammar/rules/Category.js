...
function Category(options) {
	...
	// FIXME: The three following rules that include `personNumber` are inefficiently conjugating display text via the `personNumber` property when conjugation via a `gramProps`-style property, which only conjugates a rule's immediate children, would work.
