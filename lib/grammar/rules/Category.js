 ...
 * 1. `[user-subj-filter]` -> `[verb]` `[cats+]`                => (people who) like(d) `[repos+]`
 * 2. `[user-subj-filter]` -> `[have]` `[verb]` `[cats+]`       => (people who) have liked `[repos+]`
 * 3. `[user-subj-filter]` -> `[do-not] `[verb]` `[cats+]`      => (people who) do not like `[repos+]`
 * 4. `[user-subj-filter]` -> `[have-not] `[verb]` `[cats+]`    => (people who) have not liked `[repos+]`
 * 5. `[user-head]`        -> `[agent-noun]` `[prep]` `[cats+]` => likers of `[repos+]`
