...
/**
 * Adds nonterminal rules to this `Category` that represent instances of this `Category` (i.e., the indirect object) associated with specified users (i.e., the direct object) who received this action.
 *
 * Adds the following rules for `options.catVerbSemantic`:
...
Category.prototype.addIndirectObjectVerbRuleSet  = function (options) {
	...
	// (issues) `[nom-users+]` `[be]` mentioned in
	this.objFilter.addRule({
		// The grammatical person-number in `[nom-users+]` dictates the inflection of `[be]`:
