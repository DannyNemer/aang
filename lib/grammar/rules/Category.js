...
Category.prototype.addVerbRuleSet = function (options) {
	...
	// Check `options.noPresentPerfect` and `options.noPresentPerfectNegative` are not both `true` because the former option encompasses the latter. `options.noPresentPerfect` prevents both positive and negative present-perfect rules.
