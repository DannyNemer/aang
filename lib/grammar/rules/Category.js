...
function Category(options) {
	...
	if (options.possSemantic) {
		 ...
		 *
		 * Use a separate rule to ensure only semantics `[of-poss-users+-disjunction]` produces are added to `options.possSemantic`, and not those which `this.headMayPoss` produces (e.g., `repositories-type(fork)` for "forks").
		 *
