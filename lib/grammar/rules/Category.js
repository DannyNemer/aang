...
Category.prototype.addDateRuleSet = function (options) {
	...
	// Check `options.verbTerm` is a tense-less verb terminal rule set created by `g.newVerb()` or a verb sequence created by `g.newTermSequence()` that produces sequences that each contain a verb created by `g.newVerb()`
