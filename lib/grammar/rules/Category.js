 ...
 * @param {Object} options.headTerm The `NSymbol.prototype.addWord()` options object to define the category head noun, `this.term`.
...
var categorySchema = {
	...
	isPerson: Boolean,
	headTerm: { type: Object, required: true },
...
function Category(options) {
	...
	this.term = g.newSymbol(this.namePl, 'term').addWord(options.headTerm)
