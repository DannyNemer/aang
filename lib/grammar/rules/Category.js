...
/**
 * Adds nonterminal rules to this `Category` that represent instances of this `Category` with the specified quantity of `options.itermTerm`.
 *
 ...
 * @param {Object[]} options.catCountSemantic The semantic that returns instances of this `Category` with the specified quantity of `options.itermTerm`.
 */
