	...
	if (!options.noPresentPerfect) {
		...
		this.objFilter.addRule({
			rhs: [
				...
				noSubjectConjunctions ? user.nomUsersHaveNoInsert : user.nomUsersPlusHaveNoInsert,
				{
					symbol: options.verbTerm,
					// Dictates inflection of `options.verbTerm`:
	...
	if (!options.noPresentPerfect && !options.noPresentPerfectNegative) {
		...
		this.objFilter.addRule({
			rhs: [
				...
				noSubjectConjunctions ? user.nomUsersHaveNoInsertNegation : user.nomUsersPlusHaveNoInsertNegation,
				{
					symbol: options.verbTerm,
					// Dictates inflection of `options.verbTerm`:
