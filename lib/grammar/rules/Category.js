...
Category.prototype.addSubjectVerbRuleSet = function (options) {
	...
	// Check `options.catVerbSemantic` was defined with `isPeople` to enable the verb's use as an antecedent for anaphora.
	if (!options.catVerbSemantic[0].semantic.anaphoraPersonNumber) {
		util.logError('The agent noun semantic associated with the verb', util.stylize(options.verbTerm.name), 'was defined without `isPeople`:', options.catVerbSemantic)
