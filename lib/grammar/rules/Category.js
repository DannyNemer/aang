 ...
 * @param {NSymbol} options.headNoun The term sequence of type 'noun' for the subcategory head, created by `g.newNoun()` or `g.newTermSequence()` with `type` 'noun'.
 * @returns {Category} Returns this `Category` instance.
 */
 ...
 * @memberOf Category
 * @param {Object} options The options object.
 * @param {NSymbol} options.itemNoun  The term sequence of type 'noun' for the item to quantify, created by `g.newNoun()` or `g.newTermSequence()` with `type` 'noun'.
