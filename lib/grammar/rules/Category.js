 ...
 * @param {Object} [options.agentNoun.agentNounPrepTerm] The symbol that produces the terminal rule set for the preposition that follows `options.agentNounTerm` in rule #10 of the second section of this method description, likely created by `NSymbol.prototype.addWord()`.
...
Category.prototype.addVerbRuleSet = function (options) {
	...
	if (options.agentNoun) {
		...
		this.addAgentNoun({
			...
			prepTerm: options.agentNoun.agentNounPrepTerm,
