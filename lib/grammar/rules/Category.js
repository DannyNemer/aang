 ...
 * 1. `[cat-rhs-ext]`     -> (issues) with `[item]`             => (issues) with `<int>` comments
 * 2. `[cat-subj-filter]` -> (issues that) have `[item]`        => (issues that) have `<int>` comments
 * 3. `[cat-subj-filter]` -> (issues that) do not have `[item]` => (issues that) do not have `<int>` comments
 *
 * @memberOf Category
 * @param {Object} options The options object.
