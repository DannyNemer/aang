...
/**
 * Checks if `ruleSetOptions`, which was passed to `Category.prototype.addVerbRuleSet()` or `Category.prototype.addSubjectVerbRuleSet()`, is ill-formed. If not, prints an error.
 *
 * @private
 * @static
