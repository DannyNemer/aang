...
var user = module.exports = new Category({ sg: 'user', pl: 'users', isPerson: true, entities: [ 'Danny', 'Aang', 'John von Neumann', 'John not Neumann', 'John', 'George Bush', 'Jeb Bush', 'Marc Marc', 'Max Planck Max', 'Richard Feynman', 'Elizabeth Cady Stanton' ] })
...
nomUsersPlural.addRule({ rhs: [ oneSg.plain ], semantic: oneSg.semantic, case: 'nom' })
