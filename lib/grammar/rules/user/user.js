...
nomUsersPlural.addRule({ rhs: [ oneSg.pronoun ], grammaticalForm: 'nom', semantic: oneSg.semanticArg })
...
user.objUser.addRule({ isTerminal: true, rhs: 'anyone', text: 'anyone', semantic: allUsersSemantic })
// (people who follow) `{user}`; (people followed by) `{user}`
user.objUser.addRule({ rhs: [ user.sg ] })
// (people who follow) me; (people followed by) me
user.objUser.addRule({ rhs: [ oneSg.pronoun ], grammaticalForm: 'obj', semantic: oneSg.semanticArg })
