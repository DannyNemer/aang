...
var nomUsersPluralNoUnion = g.newSymbol(user.nomUsersPlural.name, 'no', 'union')
...
var nomUsersPluralIntersect = g.newSymbol(user.nomUsersPlural.name, 'intersect').addRule({
