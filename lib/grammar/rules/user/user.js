...
// Identical to the rules `[nom-users]` produces sans the `personNumber` properties. For use in conjunctions, for which the root conjunction rules have `personNumber: 'pl'`, because conjunctions are always plural.
