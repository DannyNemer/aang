...
/**
 * NOTE: The following rules 6 rules that combine auxiliary verbs with `user` rules are inefficient and should be removed. These auxiliary verbs should be paired with the verbs they precede as part of a single term sequence to optimize term sequence flattening. However, this yields more rules in the grammar because it requires a unique binary for each verb (i.e., `[ [do], [verb] ]`), which yields more `Parser` reductions, which may yield worse performance.
 */
