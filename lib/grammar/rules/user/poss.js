...
exports.determinerSg.addRule({ rhs: [ anaphora.threeSgPossDet ], semantic: anaphora.threeSgSemanticArg })
...
possUser.addRule({ rhs: [ anaphora.threeSgPossPronoun ], semantic: anaphora.threeSgSemanticArg })
