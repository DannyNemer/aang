...
exports.pronoun = g.newSymbol('1', 'sg').addPronoun({
	...
	substitutions: [
		...
		{ symbol: 'he|she|him|her', costPenalty: 2.5 },
		{ symbol: 'they|them', costPenalty: 2.5 },
		'you|it',
...
exports.possDet = g.newSymbol(exports.pronoun.name, 'poss', 'det').addWord({
	...
	substitutions: [
		...
		{ symbol: 'his|her', costPenalty: 2.5 },
		{ symbol: 'their', costPenalty: 2.5 },
	]
})
...
exports.possPronoun = g.newSymbol(exports.pronoun.name, 'poss', 'pronoun').addWord({
	...
	substitutions: [
		...
		{ symbol: 'I', costPenalty: 0.2 },
		{ symbol: 'me', costPenalty: 0.2 },
		{ symbol: 'his|hers', costPenalty: 2.5 },
		{ symbol: 'theirs', costPenalty: 2.5 },
	],
})