...
exports.pronoun = g.newTermSequence({
	...
	acceptedTerms: [
		g.newPronoun({
			symbolName: g.hyphenate('pronoun', 1, 'sg'),
			insertionCost: 0.5,
			pronounFormsTermSet: {
				nom: 'I',
				obj: 'me',
	...
	substitutedTerms: [
		...
		{ term: anaphora.threeSg, costPenalty: anaphoraCostPenalty },
		{ term: anaphora.threePl, costPenalty: anaphoraCostPenalty },
		g.newTermSequence({
...
exports.possDet = g.newTermSequence({
	...
	substitutedTerms: [
		...
		{ term: anaphora.threeSgPossDet, costPenalty: anaphoraCostPenalty },
		{ term: anaphora.threePlPossDet, costPenalty: anaphoraCostPenalty },
	],
})
...
exports.possPronoun = g.newTermSequence({
	...
	substitutedTerms: [
		...
		{ term: 'I', costPenalty: 0.2 },
		{ term: 'me', costPenalty: 0.2 },
		{ term: anaphora.threeSgPossPronoun, costPenalty: anaphoraCostPenalty },
		{ term: anaphora.threePlPossPronoun, costPenalty: anaphoraCostPenalty },
	],
})