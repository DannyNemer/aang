...
var followers = g.newSymbol('followers').addWord({
	insertionCost: 2.5,
...
var share = g.newVerbSet({
	...
	acceptedVerbTermSets: [ {
		...
		// Define "had" as past participle instead of past tense (i.e., preterite) because "had" as an auxiliary verb implies the associated verb is no longer true: "had in common" -> no longer in common.
		pastParticiple: 'had in common',
	} ],
})
