...
var followersPossDeterminer = g.newSymbol(followers.name, user.possDeterminer.name).addRule({
...
var followersPossessiveDeterminerSg = g.newSymbol(followers.name, 'possessive', user.possDeterminerSg.name).addRule({
