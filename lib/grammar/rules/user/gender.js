...
const usersGenderSemantic = g.newSemantic({
...
const usersGenderFemaleSemantic = g.reduceSemantic(usersGenderSemantic, g.newSemantic({
	isArg: true,
	name: 'female',
	cost: 0,
}))
const usersGenderMaleSemantic = g.reduceSemantic(usersGenderSemantic, g.newSemantic({
	isArg: true,
	name: 'male',
	cost: 0,
}))
...
const womenTerm = g.newSymbol('women', 'term').addWord({
...
const menTerm = g.newSymbol('men', 'term').addWord({
	accepted: [ 'men', 'males' ],
})
