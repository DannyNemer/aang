...
var possSymNamePrefix = 'poss'

exports.possDeterminerSg = g.newSymbol(possSymNamePrefix, 'determiner', 'sg')
// my (repositories)
...
exports.possDeterminerPl = g.newSymbol(possSymNamePrefix, 'determiner', 'pl')
...
exports.possDeterminer = g.newSymbol(possSymNamePrefix, 'determiner')
...
var possUsers = g.newSymbol(possSymNamePrefix, user.namePl)
// (followers of) `{user}`
 ...
 *
 * For use by categories who semantic representing possession of instances of that category's associated DB object is defined with `forbidsMultipleIntersection`. Prevents the intersection of multiple instances of this ownership semantic because it implies the associated DB object can be owned/authored by multiple users. Only enables the logical disjunction of multiple instances of said semantic.
 *
