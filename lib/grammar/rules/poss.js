...
possUserPlural.addRule({ RHS: [ [ user.objUser, conjunctions.and ], user.objUsersPlus ], noInsertionIndexes: [ 0 ] })
// (followers of) me or Danny
possUserPlural.addRule({ RHS: [ [ user.objUser, conjunctions.union ], user.objUsersPlus ], noInsertionIndexes: [ 0 ], semantic: conjunctions.unionSemantic })
...
exports.ofPossUsersPlus = g.newBinaryRule({ RHS: [ preps.possessor, possUsersPlus ], noInsertionIndexes: [ 0, 1 ] })