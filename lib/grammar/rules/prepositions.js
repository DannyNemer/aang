...
exports.agent = g.newSymbol(prepStr, 'agent').addWord({
	...
	accepted: [ 'by' ],
	substitutions: [
		{ symbol: g.newBlankSet('from', 'via'), costPenalty: 1 },
...
exports.associative = g.newSymbol(prepStr, 'associative').addWord({
	...
	accepted: [ 'with' ],
	substitutions: [
		{ symbol: g.newBlankSet('alongside', 'of', 'to'), costPenalty: 1 },
...
exports.possessed = g.newSymbol(prepStr, 'possessed').addWord({
	...
	accepted: [ 'with' ],
	substitutions: [
		{ symbol: g.newBlankSet('have', 'having', 'containing'), costPenalty: 1 },
		{ symbol: prepCommonBlank, costPenalty: 2 },
	],
})
