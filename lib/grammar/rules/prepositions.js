...
var termEarlier = g.newTermSequence({
	symbolName: g.hyphenate('term', 'earlier'),
	acceptedTerms: [ 'earlier' ],
})

var termPrior = g.newTermSequence({
	symbolName: g.hyphenate('term', 'prior'),
...
exports.before = g.newTermSequence({
	...
	acceptedTerms: [
		...
		[ termEarlier, exports.than ],
		[ termPrior, exports.to ],
		'<'
	],
	substitutedTerms: [
