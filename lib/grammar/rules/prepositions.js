...
var prepCommonBlank = g.newSymbol(prepStr, 'common', 'blank').addBlankSet({
...
exports.agent = g.newSymbol(prepStr, 'agent').addWord({
	...
	accepted: [ 'by' ],
	substitutions: [
		{ symbol: g.newSymbol('from|via', 'blank').addBlankSet({
			terms: [ 'from', 'via' ],
		}), costPenalty: 1 },
		{ symbol: 'of', costPenalty: 0.5 },
		{ symbol: g.newSymbol(prepStr, 'agent', 'blank').addBlankSet({
...
exports.associative = g.newSymbol(prepStr, 'associative').addWord({
	...
	accepted: [ 'with' ],
	substitutions: [
		{ symbol: g.newSymbol('alongside|of|to', 'blank').addBlankSet({
			terms: [ 'alongside', 'of', 'to' ],
		}), costPenalty: 1 },
		{ symbol: g.newSymbol(prepStr, 'associative', 'blank').addBlankSet({
...
exports.container = g.newSymbol(prepStr, 'container').addWord({
	...
	substitutions: [
		...
		{ symbol: g.newSymbol(prepStr, 'container', 'blank').addBlankSet({
...
exports.possessed = g.newSymbol(prepStr, 'possessed').addWord({
	...
	accepted: [ 'with' ],
	substitutions: [
		{ symbol: g.newSymbol('have|having|containing', 'blank').addBlankSet({
...
exports.between = g.newSymbol(prepStr, 'between').addWord({
	...
	accepted: [ 'between' ],
	substitutions: [
		{ symbol: g.newSymbol(prepStr, 'between', 'blank').addBlankSet({
