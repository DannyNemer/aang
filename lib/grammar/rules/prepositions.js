...
exports.agent = g.newSymbol(prepStr, 'agent').addWord({
	...
	accepted: [ 'by' ],
	substitutions: [
		{ symbol: g.newSymbol('from|via', 'blank').addBlankSet({ terms: [ 'from', 'via' ] }), costPenalty: 1 },
		{ symbol: 'of', costPenalty: 0.5 },
		{ symbol: g.newSymbol(prepStr, 'agent', 'blank').addBlankSet({ terms: [ 'aboard', 'above', 'absent', 'across', 'afore', 'after', 'against', 'along', 'alongside', 'amid', 'amidst', 'among', 'amongst', 'around', 'aside', 'astride', 'at', 'athwart', 'atop', 'barring', 'before', 'behind', 'below', 'beneath', 'beside', 'besides', 'between', 'betwixt', 'beyond', 'but', 'by', 'despite', 'down', 'during', 'except', 'excluding', 'failing', 'following', 'for', 'from', 'given', 'in', 'including', 'inside', 'into', 'lest', 'like', 'minus', 'modulo', 'near', 'next', 'notwithstanding', 'of', 'off', 'on', 'onto', 'opposite', 'out', 'outside', 'over', 'pace', 'past', 'per', 'plus', 'pro', 'qua', 'sans', 'save', 'since', 'than', 'through', 'thru', 'throughout', 'thruout', 'till', 'times', 'to', 'toward', 'towards', 'under', 'underneath', 'unlike', 'until', 'unto', 'up', 'upon', 'versus', 'vs', 'via', 'with', 'within', 'without', 'worth' ] }), costPenalty: 3 },
	],
})
...
exports.possessor = g.newSymbol(prepStr, 'possessor').addWord({
	...
	substitutions: [
		...
		{ symbol: prepCommonBlank, costPenalty: 2 },
	],
})
...
exports.possessed = g.newSymbol(prepStr, 'possessed').addWord({
	...
	accepted: [ 'with' ],
	substitutions: [
		{ symbol: g.newSymbol('have|having|containing', 'blank').addBlankSet({ terms: [ 'have', 'having', 'containing' ] }), costPenalty: 1 },
		{ symbol: prepCommonBlank, costPenalty: 2 },
	],
})
