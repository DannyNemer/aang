...
exports.agent = g.newSymbol(prepSymNamePrefix, 'agent').addWord({
	insertionCost: 0.5,
	accepted: [ 'by' ],
	substitutions: [
...
exports.benefactive = g.newInvariableTerm({
	symbolName: g.hyphenate(prepSymNamePrefix, 'benefactive'),
	insertionCost: 0.5,
	acceptedTerms: [ 'at', 'for' ],
	substitutedTerms: [
		// NOTE: Temporarily define substitutions as such until finalizing design of preposition substitutions.
...
exports.to = g.newInvariableTerm({
