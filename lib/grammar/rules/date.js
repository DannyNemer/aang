...
var month = g.newSymbol('month').addRule({
	rhs: [ g.newSymbol('january').addWord({ accepted: [ 'January' ], substitutions: [ '1' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'jan', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('february').addWord({ accepted: [ 'February' ], substitutions: [ '2' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'feb', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('march').addWord({ accepted: [ 'March' ], substitutions: [ '3' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'mar', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('april').addWord({ accepted: [ 'April' ], substitutions: [ '4' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'apr', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('may').addWord({ accepted: [ 'May' ], substitutions: [ '5' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'may', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('june').addWord({ accepted: [ 'June' ], substitutions: [ '6' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'jun', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('july').addWord({ accepted: [ 'July' ], substitutions: [ '7' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'jul', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('august').addWord({ accepted: [ 'August' ], substitutions: [ '8' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'aug', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('september').addWord({ accepted: [ 'September' ], substitutions: [ '9' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'sep', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('october').addWord({ accepted: [ 'October' ], substitutions: [ '10' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'oct', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('november').addWord({ accepted: [ 'November' ], substitutions: [ '11' ] }) ],
	semantic: g.newSemantic({ isArg: true, name: 'nov', cost: 0.5 })
}).addRule({
	rhs: [ g.newSymbol('december').addWord({ accepted: [ 'December' ], substitutions: [ '12' ] }) ],
