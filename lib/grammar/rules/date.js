...
// The following two rules require `date-interval-semantic()` to keep interval-bound semantics within a single LHS (parent) semantic, which will have `maxParams` as 1 and be copied otherwise.
