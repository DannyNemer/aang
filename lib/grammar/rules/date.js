...
// (repos created) <from> before (`[date-phrase-or-value]`)
...
// (repos created) <from> after (`[date-phrase-or-value]`)
...
// (repos created) <from> between `[date-phrase-or-value]` and `[date-phrase-or-value]`
// Requires `date-interval-semantic()` to keep interval bound semantics within a single LHS semantic.
dateInterval.addRule({ rhs: [
...
// (repos created) before/after `[date-phrase-or-value]`
// (repos created) before/after `[date-phrase-or-value]` and before/after `[date-phrase-or-value]`
// (repos created) from `[date-phrase-or-value]` to `[date-phrase-or-value]`
// (repos created) between `[date-phrase-or-value]` and `[date-phrase-or-value]`
