...
exports.openers = g.newTermSequence({
	...
	acceptedTerms: [
		g.newCountNoun({
			// Note: This insertion cost is not used because `[noun-creators]` has a smaller cost.
			insertionCost: 3,
...
exports.employees = g.newCountNoun({
	insertionCost: 2.75,
	nounFormsSet: { sg: 'employee', pl: 'employees' },
})

// (companies with `<int>`) workers -> employees
exports.workers = g.newCountNoun({
	nounFormsSet: { sg: 'worker', pl: 'workers' },
})
