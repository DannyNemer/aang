...
exports.assign = g.newVerb({
	symbolName: g.hyphenate(verbSymNamePrefix, 'assign'),
	insertionCost: 0.7,
	verbFormsTermSet: {
		oneSg: 'assign',
		threeSg: 'assigns',
...
exports.invest = g.newVerb({
	symbolName: g.hyphenate(verbSymNamePrefix, 'invest'),
...
exports.fund = g.newVerb({
	symbolName: g.hyphenate(verbSymNamePrefix, 'fund'),
	verbFormsTermSet: {
		oneSg: 'fund',
		threeSg: 'funds',
		pl: 'fund',
...
exports.finance = g.newVerb({
	symbolName: g.hyphenate(verbSymNamePrefix, 'finance'),
	verbFormsTermSet: {
		oneSg: 'finance',
		threeSg: 'finances',
		pl: 'finance',
...
exports.consultTense = g.newVerb({
	symbolName: g.hyphenate(verbSymNamePrefix, 'consult'),
