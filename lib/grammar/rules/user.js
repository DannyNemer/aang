...
var andNomPlUsersPlus = g.newBinaryRule({
	RHS: [ conjunctions.and, nomPlUsersPlus ],
	noInsertionIndexes: [ 0, 1 ],
})
nomPlUsersPlus.addRule({
	RHS: [ nomPlUsers, andNomPlUsersPlus ],
	noInsertionIndexes: [ 0, 1 ],
})
// (people I and/or) {user} or {user} (follow)
var unionNomPlUsersPlus = g.newBinaryRule({
	RHS: [ conjunctions.union, nomPlUsersPlus ],
	noInsertionIndexes: [ 0, 1 ],
})
nomPlUsersPlus.addRule({
	RHS: [ nomPlUsers, unionNomPlUsersPlus ],
...
// Only produces plural subjects.
user.nomPlUsersSubj = g.newSymbol('nom', 'pl', user.namePl, 'subj')
// (followers) my followers (share)
user.nomPlUsersSubj.addRule({ RHS: [ user.plural ], personNumber: 'pl' })
// (followers) I and {user} (share)
user.nomPlUsersSubj.addRule({ RHS: [ nomPlUsers, andNomPlUsersPlus ], personNumber: 'pl' })
...
user.objUsersPlus = conjunctions.addForSymbol(user.objUsers)
