...
// Identical rule structure to rules `conjunctions.create()` produces, though defined here because several of the RHS symbols are needed elsewhere in this module.
...
// Do not use `conjunctions.create()` because conjunctions must use rules without person-number properties to enable proper conjugation.
