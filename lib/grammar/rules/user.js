...
var objUser = g.newSymbol('obj', user.nameSg)
// (people who follow) anyone
objUser.addRule({ isTerminal: true, RHS: 'anyone', semantic: allUsersSemantic })
// (people who follow) {user}; (people followed by) {user}
objUser.addRule({ RHS: [ user.catSg ] })
// (people who follow) me; (people followed by) me
objUser.addRule({ RHS: [ oneSg.plain ], semantic: oneSg.semantic, gramCase: 'obj' })
