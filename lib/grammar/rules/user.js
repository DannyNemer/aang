...
user.nomUsersPlusHaveNoInsert = g.newBinaryRule({ RHS: [ user.nomUsersPlus, auxVerbs.have ], noInsertionIndexes: [ 0, 1 ] })
// (repos) [nom-users+] have/has <stop> (contributed to)
user.nomUsersPlusHaveNoInsertPreVerbStopWord = g.newBinaryRule({ RHS: [ user.nomUsersPlus, auxVerbs.haveNoInsertPreVerbStopWord ], noInsertionIndexes: [ 0, 1 ] })

// (repos) [nom-users+] do/does not (like)
user.nomUsersPlusDoPresentNegation = g.newBinaryRule({ RHS: [ user.nomUsersPlus, auxVerbs.doPresentNegation ], noInsertionIndexes: [ 0, 1 ] })
// (repos) [nom-users+] did not (fork)
user.nomUsersPlusDoPastNegation = g.newBinaryRule({ RHS: [ user.nomUsersPlus, auxVerbs.doPastNegation ], noInsertionIndexes: [ 0, 1 ] })
...
user.nomUsersPlusHaveNoInsertNegation = g.newBinaryRule({ RHS: [ user.nomUsersPlus, auxVerbs.haveNoInsertNegation ], noInsertionIndexes: [ 0, 1 ] })
...
user.byObjUsersPlus = g.newBinaryRule({ RHS: [ preps.agent, user.objUsersPlus ], noInsertionIndexes: [ 0, 1 ] })
