...
exports.addForSymbol = function (symbol, noConjunctionInsert) {
	...
	symbolPlus.addRule({ RHS: [ symbolAnd, symbolPlus ], noInsertionIndexes: [ 0, 1 ] })
	...
	symbolPlus.addRule({ RHS: [ symbolUnion, symbolPlus ], semantic: exports.unionSemantic, noInsertionIndexes: [ 0, 1 ] })
