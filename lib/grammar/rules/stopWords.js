		...
		{ term: 'never', costPenalty: 1.5 },
		{
			...
			term: [
				...
				g.newTermSequence({
					...
					// Temporarily disable insertion because matching "the" yields ambiguity with the insertion rules created from this binary rule and the next, for which `flattenTermSequence` throws an exception.
					// insertionCost: 0.5,
					type: g.termTypes.INVARIABLE,
