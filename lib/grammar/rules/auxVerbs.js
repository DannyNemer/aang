...
exports.have = g.newVerb({
	...
	acceptedVerbTermSets: [ {
		...
		// Also, do not define as `past`, otherwise the nonterminal rule [have][create], defined with grammatical form "past", would yield "had created".
		pastParticiple: 'had',
	} ],
})

// (people who have) been (followed by me)
var bePast = g.newSymbol('be', 'past').addWord({
	insertionCost: 1,
	accepted: [ 'been' ],
})
...
exports.haveSentenceAdverbialBePast = g.newBinaryRule({ rhs: [ haveSentenceAdverbial, bePast ] })

// Temporary rule until finalizing use of stop-words.
exports.haveBeen = g.newBinaryRule({
	rhs: [ exports.have, bePast ],
})
...
exports.haveNegationBePast = g.newBinaryRule({ rhs: [ haveNegationPlSubj, bePast ] })
