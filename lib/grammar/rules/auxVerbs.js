...
exports.beNon1SgNegation = g.newBinaryRule({
	rhs: [ exports.beNon1Sg, negation.createRuleSet(exports.beNon1Sg.name, [ 'are', 'were' ]) ],
})
...
exports.beGeneralNegation = g.newBinaryRule({
	rhs: [ exports.beGeneral, negation.createRuleSet(exports.beGeneral.name, [ 'is', 'are', 'was', 'were' ]) ],
})
...
var haveNotStopWordNegation = negation.createRuleSet('have', [ 'have', 'has', 'had' ])
...
var doNotStopWordNegation = negation.createRuleSet('do', [ 'do', 'does', 'did' ])
