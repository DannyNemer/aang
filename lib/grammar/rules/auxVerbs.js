...
exports.doPresentNegation = g.newTermSequenceBinarySymbol({
	symbolName: g.hyphenate(doVerb.name, 'present', exports.negation.name),
...
exports.doPresentNegationHave = g.newBinaryRule({
	...
	// Dictates inflection of both `[do]` and `[have]`:
