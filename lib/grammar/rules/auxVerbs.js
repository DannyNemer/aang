...
exports.negation = g.newSymbol('negation').addWord({
	...
	substitutions: [
		[
			...
			g.newSymbol('not', 'blank').addBlankSet({ terms: [ 'not' ] }),
		],
...
var beingBeenBlank = g.newSymbol('being|been', 'blank').addBlankSet({ terms: [ 'being', 'been' ] })
var beingBlank = g.newSymbol('being', 'blank').addBlankSet({ terms: [ 'being' ] })
exports.beNon1Sg = g.newSymbol('be', 'non', '1', 'sg').addWord({
	insertionCost: 1,
	accepted: [ 'are', 'were' ],
	substitutions: [
		[
			g.newSymbol('is|are|be', 'blank').addBlankSet({ terms: [ 'is', 'are', 'be' ] }),
			beingBlank,
		],
		beingBeenBlank,
	],
...
exports.beGeneral = g.newSymbol('be', 'general').addVerb({
	...
	substitutions: [
		...
		beingBeenBlank,
		[
			g.newSymbol('am|is|are|be', 'blank').addBlankSet({ terms: [ 'am', 'is', 'are', 'be' ] }),
			beingBlank,
		]
	],
}).addVerb({
	...
	substitutions: [
		[
			g.newSymbol('has|have', 'blank').addBlankSet({ terms: [ 'has', 'have' ] }),
			[
				g.newSymbol('been', 'blank').addBlankSet({ terms: [ 'been' ] }),
				beingBlank,
			],
		]
	],
...
var doTerm = g.newSymbol('do', 'term').addVerb({
	...
	substitutions: [
		'doing',
		[
			g.newSymbol('had|have|has', 'blank').addBlankSet({ terms: [ 'had', 'have', 'has' ] }),
			g.newSymbol('done', 'blank').addBlankSet({ terms: [ 'done' ] }),
		],
	],
})
