...
exports.doPresentNegation.addRule({ isTerminal: true, RHS: 'didn\'t|don\'t|didnt|dont', text: 'do not' })
...
exports.doPastNegation.addRule({ isTerminal: true, RHS: 'didn\'t|don\'t|didnt|dont', text: 'did not' })