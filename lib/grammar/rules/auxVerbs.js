...
const haveSentenceAdverbial = g.newBinaryRule({
...
const haveNotStopWordNegation = negation.createRuleSet(exports.have)
...
const haveNegationPlSubj = g.newBinaryRule({
	rhs: [ exports.have, haveNotStopWordNegation ],
	personNumber: 'pl',
})
...
const doTerm = g.newSymbol('do').addVerb({
	insertionCost: 0.2,
	oneSg: 'do',
	threeSg: 'does',
	pl: 'do',
...
const doNotStopWordNegation = negation.createRuleSet(doTerm)
