...
exports.have = g.newVerbSet({
	...
	acceptedVerbTermSets: [ {
		...
		/**
		 * Define "had" as past participle instead of past tense (i.e., preterite) because "had" as an auxiliary verb implies the associated verb is no longer true: "had followed" -> no longer follows.
		 *
		 * Also, assigning "had" to `pastParticiple` adds the `tense` property to its terminal rule, allowing input tense to be maintained for substitutions that use `[have]`.
		 *
