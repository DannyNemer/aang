...
var categoryOptsSchema = {
	...
	pl: String,
	// Specifies whether this category is person. This is used for relative pronouns (i.e., "that" vs. "who").
	isPerson: { type: Boolean, optional: true },
	// Optional entities for this category to also make it an entity category.
 ...
 *
 * @param {Object} opts The otpions object.
 * @returns {Category} Returns the new `Category` instance.
 */
