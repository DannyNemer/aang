...
repository.inner.addRule({ rhs: [ preps.possessed, count.create(stars) ], semantic: g.newSemantic({
	name: g.hyphenate(repository.nameSg, 'star', 'count'),
	cost: 0.5,
	minParams: 1,
	maxParams: 1,
}) })
