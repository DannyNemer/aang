...
var likedRepositoriesPlus = g.newBinaryRule({ rhs: [ like, repository.catPlPlus ], grammaticalForm: 'past' })
...
var contributeToPastRepositoriesPlus = g.newBinaryRule({ rhs: [ contributeTo, repository.catPlPlus ], grammaticalForm: 'past' })
user.subjFilter.addRule({
...
user.subjFilter.addRule({ rhs: [ fork, repository.catPlPlus ], semantic: repositoryCreatorsForksSemantic, grammaticalForm: 'past' })
// (people who) have forked [repositories+]
var forkPastRepositoriesPlus = g.newBinaryRule({ rhs: [ fork, repository.catPlPlus ], grammaticalForm: 'past' })
user.subjFilter.addRule({
