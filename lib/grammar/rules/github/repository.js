...
// {repository} likers
user.head.addRule({ rhs: [ repository.sg, likers ], semantic: repositoryLikersSemantic })
...
user.head.addRule({
	rhs: [ contributors, [ preps.receiver, repository.plPlus ] ],
	noInsertionIndexes: [ 0 ],
	transpositionCost: 1,
	semantic: repositoryContributorsSemantic,
})
// {repository} contributors
user.head.addRule({ rhs: [ repository.sg, contributors ], semantic: repositoryContributorsSemantic })
