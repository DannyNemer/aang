...
user.subjFilter.addRule({ RHS: [ auxVerbs.have, forkPastRepositoriesPlus ], semantic: repositoryCreatorsForksSemantic, noInsertionIndexes: [ 0 ] })
...
// public (repos of mine); (repos who are) public; (my) public (repos)
repository.adjective.addRule({
	isTerminal: true,
	RHS: 'public',
	semantic: g.reduceSemantic(repositoriesTypeSemantic, publicSemanticArg)
})
