...
user.subjFilter.addRule({ rhs: [ github.haveNoInsertCreatePast, repository.plPlus ], semantic: repositoryCreatorsSemantic })
...
repository.addVerbRuleSet({
	...
	// Prevent present tense to describe repository forking, an action-relationship that can only be represented as a past event:
