...
// (repos) I created
repository.objFilter.addRule({ rhs: [ user.nomUsers, github.create ], semantic: repositoriesCreatedSemantic, grammaticalForm: 'past' })
// (repos) I have created
repository.objFilter.addRule({ rhs: [ user.nomUsersHaveNoInsert, github.create ], semantic: repositoriesCreatedSemantic, grammaticalForm: 'past' })
...
repository.objFilter.addRule({
	rhs: [ user.nomUsersDoPastNegation, github.create ],
	personNumber: 'pl',
	semantic: g.reduceSemantic(auxVerbs.notSemantic, repositoriesCreatedSemantic),
})
...
user.subjFilter.addRule({ rhs: [ github.create, repository.plPlus ], semantic: repositoryCreatorsSemantic, grammaticalForm: 'past' })
// (people who) have created `[repositories+]`
user.subjFilter.addRule({
	rhs: [
		auxVerbs.have,
		g.newBinaryRule({
			rhs: [ github.create, repository.plPlus ],
...
user.subjFilter.addRule({
	rhs: [ [ auxVerbs.doPastNegation, github.create ], repository.plPlus ],
	semantic: g.reduceSemantic(auxVerbs.notSemantic, repositoryCreatorsSemantic),
})
