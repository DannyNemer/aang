...
// MENTION:
exports.mentionedIn = g.newBinaryRule({
	rhs: [ verbs.mention, preps.in ],
	grammaticalForm: 'past',
})

// (pull-requests/issues) I-am/`{user}`-is/`[users]`-are mentioned in
exports.beMentionedIn = g.newBinaryRule({ rhs: [ auxVerbs.be, exports.mentionedIn ] })
// (pull-requests/issues) I-am/`{user}`-is/`[users]`-are not mentioned in
exports.beNegationMentionedIn = g.newBinaryRule({ rhs: [ auxVerbs.beNegation, exports.mentionedIn ] })
...
user.inner.addRule({
	rhs: [ exports.mentionedIn, mentionersPlus ],
