...
user.inner.addRule({
	rhs: [ verbs.mentionedIn, mentionersPlus ],
...
exports.beAssignedTo = g.newBinaryRule({ rhs: [ auxVerbs.be, verbs.assignedTo ] })
// (issues/pull-requests) I-am/`{user}`-is/`[users]`-are not assigned to
exports.beNegationAssignedTo = g.newBinaryRule({ rhs: [ auxVerbs.beNegation, verbs.assignedTo ] })
...
user.inner.addRule({
	rhs: [ verbs.assignedTo, assignersPlus ],
	semantic: g.newSemantic({
