...
exports.mention = g.newTermSequence({
	symbolName: 'mention',
	insertionCost: 1,
	acceptedTerms: [ 'mention' ],
	substitutedTerms: [ 'mentioning' ],
})
...
var mentionedIn = g.newTermSequenceBinarySymbol({
	termPair: [
		g.newTermSequence({
			symbolName: 'mentioned',
			insertionCost: 1,
			acceptedTerms: [ 'mentioned' ],
		}),
		preps.in,
	],
})
