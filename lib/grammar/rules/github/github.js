...
const github = g.newSymbol('github').addWord({
	accepted: [ 'GitHub' ],
})
...
const mentionedIn = g.newSymbol('mentioned', 'in').addWord({
	insertionCost: 1.1,
...
const mentionersPlus = conjunctions.create(exports.mentioners)
...
const assignersPlus = conjunctions.create(exports.assigners)
...
// WITH N COMMENTS:
const comments = g.newSymbol('comments').addWord({
	insertionCost: 3,
	accepted: [ 'comments' ],
