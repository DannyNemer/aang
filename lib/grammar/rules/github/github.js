...
exports.doPastNegationCreatePresent = g.newSymbol(auxVerbs.doPastNegation.name, exports.create.name, 'present').addRule({
	rhs: [ auxVerbs.doPastNegation, exports.create ],
	personNumber: 'pl',
})

// (repos/pull-requests I) [have-opt] created
// (people who) [have-opt] created ([repos]/[pull-requests])
exports.haveOptCreatePast = g.newSymbol(auxVerbs.have.name, 'opt', exports.create.name).addRule({
	rhs: [ auxVerbs.have, exports.create ],
