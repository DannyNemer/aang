...
issue.addVerbRuleSet({
	...
	//   Stop: (repos) `[nom-users+-no-intersect]` fork(s)
	//   Stop: (repos) `[nom-users+-no-intersect]` do/does not fork
	...
	//   Stop: (issues) `[nom-users+-no-intersect]` have/has not opened
	//   Stop: (people who) have not opened `[issues+]`
	noPresentPerfectNegative: true,
	// Verb rules for `issues-opened()`:
	//   (issues) opened by `[obj-users+-no-intersect]`
	//   (issues) `[nom-users+-no-intersect]` opened
	//   (issues) `[nom-users+-no-intersect]` have/has opened
	//   (issues) `[nom-users+-no-intersect]` did not open
