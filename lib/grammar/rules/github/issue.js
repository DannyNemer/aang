...
issue.objFilter.addRule({ rhs: [ user.nomUsersDoPastNegation, open ], personNumber: 'pl', semantic: g.reduceSemantic(auxVerbs.notSemantic, issuesOpenedSemantic) })
...
user.subjFilter.addRule({ rhs: [ [ auxVerbs.doPastNegation, open ], issue.plPlus ], semantic: g.reduceSemantic(auxVerbs.notSemantic, issueOpenersSemantic) })
// openers of `[issues+]`
issue.addAgentNoun({
