...
issue.objFilter.addRule({ rhs: [ user.nomUsersPlusBe, github.mentionedIn ], semantic: issuesMentionedSemantic })
// (issues) `[nom-users+]` `[be]` not mentioned in
issue.objFilter.addRule({ rhs: [ user.nomUsersPlusBeNegation, github.mentionedIn ], semantic: g.reduceSemantic(auxVerbs.notSemantic, issuesMentionedSemantic) })
