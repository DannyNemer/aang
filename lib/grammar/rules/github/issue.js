...
issue.objFilter.addRule({ rhs: [ user.nomUsersPlusBe, verbs.mentionedIn ], semantic: issuesMentionedSemantic })
// (issues) `[nom-users+]` `[be]` not mentioned in
issue.objFilter.addRule({ rhs: [ user.nomUsersPlusBeNegation, verbs.mentionedIn ], semantic: g.reduceSemantic(auxVerbs.notSemantic, issuesMentionedSemantic) })
...
issue.inner.addRule({ rhs: [ verbs.assignedTo, user.objUsersPlus ], semantic: issuesAssignedSemantic })
// (issues) `[nom-users+]` `[be]` assigned to
issue.objFilter.addRule({ rhs: [ user.nomUsersPlusBe, verbs.assignedTo ], semantic: issuesAssignedSemantic })
// (issues) `[nom-users+]` `[be]` not assigned to
issue.objFilter.addRule({ rhs: [ user.nomUsersPlusBeNegation, verbs.assignedTo ], semantic: notIssuesAssignedSemantic })
