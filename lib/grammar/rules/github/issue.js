...
// issues of mine
issue.head.addRule({ rhs: [ issue.headMayPoss, user.ofPossUsers ], semantic: issuesOpenedSemantic })
...
issue.addVerbRuleSet({
	...
	//   Stop: (repos) `[nom-users+-disjunction]` fork(s)
	//   Stop: (repos) `[nom-users+-disjunction]` do/does not fork
