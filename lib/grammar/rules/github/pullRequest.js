...
pullRequest.addVerbRuleSet({
	...
	//   Stop: (pull requests) `[nom-users+-no-intersect]` create(s)
	//   Stop: (pull requests) `[nom-users+-no-intersect]` do/does not create
	...
	//   Stop: (pull requests) `[nom-users+-no-intersect]` have/has not created
	//   Stop: (people who) have not created `[pull-requests+]`
	noPresentPerfectNegative: true,
	// Verb rules for `pull-requests-created()`:
	//   (pull requests) created by `[obj-users+-no-intersect]`
	//   (pull requests) `[nom-users+-no-intersect]` created
	//   (pull requests) `[nom-users+-no-intersect]` have/has created
	//   (pull requests) `[nom-users+-no-intersect]` did not open
