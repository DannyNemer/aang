...
pullRequest.objFilter.addRule({
	...
	personNumber: 'pl',
	semantic: g.reduceSemantic(auxVerbs.notSemantic, pullRequestsCreatedSemantic),
})
...
user.subjFilter.addRule({
	rhs: [
		auxVerbs.have,
		g.newBinaryRule({
			rhs: [ github.create, pullRequest.plPlus ],
...
user.subjFilter.addRule({
	rhs: [ [ auxVerbs.doPastNegation, github.create ], pullRequest.plPlus ],
	semantic: g.reduceSemantic(auxVerbs.notSemantic, pullRequestCreatorsSemantic),
})
