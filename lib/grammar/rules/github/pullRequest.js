 ...
 *
 * Use `[of-poss-users+-disjunction]` instead of `[of-poss-users+]` because `pull-requests-created()`, which is defined with `forbidsMultiple`, prevents multiple instances of the semantic function within an `intersect()`.
 */
