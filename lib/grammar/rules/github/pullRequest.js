...
// (pull requests) I `[have-opt]` created
pullRequest.objFilter.addRule({ rhs: [ user.nomUsersHaveOpt, github.create ], semantic: pullRequestsCreatedSemantic, grammaticalForm: 'past' })
...
pullRequest.objFilter.addRule({ rhs: [ user.nomUsersPlusPreVerbStopWord, github.beMentionedIn ], semantic: pullRequestsMentionedSemantic })
// (pull requests) I-am/`{user}`-is/`[users]`-are not mentioned in
pullRequest.objFilter.addRule({ rhs: [ user.nomUsersPlusPreVerbStopWord, github.beNegationMentionedIn ], semantic: notPullRequestsMentionedSemantic })
...
pullRequest.objFilter.addRule({ rhs: [ user.nomUsersPlusPreVerbStopWord, github.beAssignedTo ], semantic: pullRequestsAssignedSemantic })
// (pull requests) I-am/`{user}`-is/`[users]`-are not assigned to
pullRequest.objFilter.addRule({ rhs: [ user.nomUsersPlusPreVerbStopWord, github.beNegationAssignedTo ], semantic: g.reduceSemantic(auxVerbs.notSemantic, pullRequestsAssignedSemantic) })
