...
pullRequest.objFilter.addRule({ rhs: [ user.nomUsersPlusBe, github.mentionedIn ], semantic: pullRequestsMentionedSemantic })
// (pull requests) `[nom-users+]` `[be]` not mentioned in
pullRequest.objFilter.addRule({ rhs: [ user.nomUsersPlusBeNegation, github.mentionedIn ], semantic: g.reduceSemantic(auxVerbs.notSemantic, pullRequestsMentionedSemantic) })
