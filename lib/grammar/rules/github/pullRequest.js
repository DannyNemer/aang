...
pullRequest.objFilter.addRule({ RHS: [ user.nomUsersPreVerbStopWord, github.create ], semantic: pullRequestsCreatedSemantic, tense: 'past' })
// (pull requests) I <stop> have created
pullRequest.objFilter.addRule({ RHS: [ user.nomUsersPreVerbStopWord, github.haveNoInsertCreatePast ], semantic: pullRequestsCreatedSemantic })
...
user.subjFilter.addRule({ RHS: [ github.create, pullRequest.catPl ], semantic: pullRequestCreatorsSemantic, tense: 'past' })
