...
pullRequest.objFilter.addRule({
	rhs: [ user.nomUsersPlusBe, verbs.mentionedIn ],
	semantic: pullRequestsMentionedSemantic,
})
// (pull requests) `[nom-users+]` `[be]` not mentioned in
pullRequest.objFilter.addRule({
	rhs: [ user.nomUsersPlusBeNegation, verbs.mentionedIn ],
	semantic: g.reduceSemantic(auxVerbs.notSemantic, pullRequestsMentionedSemantic),
})
...
pullRequest.objFilter.addRule({
	rhs: [ user.nomUsersPlusBe, verbs.assignedTo ],
	semantic: pullRequestsAssignedSemantic,
})
// (pull requests) `[nom-users+]` `[be]` not assigned to
pullRequest.objFilter.addRule({
	rhs: [ user.nomUsersPlusBeNegation, verbs.assignedTo ],
	semantic: g.reduceSemantic(auxVerbs.notSemantic, pullRequestsAssignedSemantic),
})
