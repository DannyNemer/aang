 ...
 *
 * @param {Symbol} itemsSymbol The `Symbol` for the noun being quantified.
 * @returns {Symbol} Returns the new `Symbol` that produces new rules for number-based queries.
 */
