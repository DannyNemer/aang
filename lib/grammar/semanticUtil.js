/**
 * Utility methods, which `semantic` inherits, for manipulating string and
 * object representations of semantic.
 */
...
/**
 * Converts `semanticArray` to a lambda calculus string representation (e.g.,
 * `func(arg,arg)`).
 *
 * Used to check if completed parse trees are semantically identical. (Semantic
 * arguments are sorted during construction.)
 *
 * @static
...
/**
 * Coverts `semanticArray` to a string representation like
 * `semantic.toString()`, but with syntax highlighting (for printing).
 *
 * @static
 * @memberOf semanticUtil
 * @param {Object[]} semanticArray The semantic to convert.
 * @returns {string} Returns the stylized string representation of
 * `semanticArray`.
 */
 ...
 * @returns {Object} Returns the simplified Object representation of
 * `semanticArray`.
 */
...
/**
 * Converts `semanticString` output by `semantic.toString()` to its original
 * object array format.
 *
 * @static
 * @memberOf semanticUtil
...
exports.stringToObject = function (semanticString) {
	...
	if (firstLeftParen === -1) {
		return [ {
			// Map string to semantic argument definition or create an object
			// for semantics created from input (e.g., entities). This enables
			// parameter checks in `printParseResults`.
...
/**
 * Checks if the root semantic of `semanticArray` has the property
 * `forbidsMultipleIntersection` defined as `true`.
 *
 * The semantic property `forbidsMultipleIntersection` specifies forbidding
 * multiple instances of its semantic function in the arguments of an
 * `intersect()`, irrespective of this semantic's arguments.
 *
 * @static
 * @memberOf semanticUtil
 * @param {Object[]} semanticArray The semantic node array to inspect.
 * @returns {boolean} Returns `true` if the root of `semanticArray` has
