 ...
 * @param {boolean} [printWarnings] Specify printing warnings for ill-formed rules and symbols.
 ...
 * @static
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 * @param {boolean} [printWarnings] Specify warnings for rule-less nonterminal symbols.
 ...
 * @static
 * @param {Object} ruleSets The map of the grammar's nonterminal symbols to rules.
 * @param {boolean} [printWarnings] Specify printing warnings for symbols unreachable via the start symbol.
