...
exports.sortRules = function () {
	Object.keys(exports.ruleSets).sort().forEach(function (symbolName) {
		// Sort rules by increasing cost.
		var rules = exports.ruleSets[symbolName].sort(function (ruleA, ruleB) {
			return ruleA.cost - ruleB.cost
		})

		// Sort nonterminal symbols alphabetically.
		delete exports.ruleSets[symbolName]
		exports.ruleSets[symbolName] = rules
	})
}
