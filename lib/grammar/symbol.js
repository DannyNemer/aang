 ...
 * @param {Object} [options.terminal=false] Specify the rule is terminal.
...
Symbol.prototype.newTerminalRule = function (options) {
	...
	if (intSymbol.creationLines.hasOwnProperty(options.RHS) || entityCategory.creationLines.hasOwnProperty(options.RHS)) {
		newRule.isPlaceholder = true
	}

	if (options.RHS === g.emptySymbol || newRule.isPlaceholder) {
	...
	// If semantic, must be completely reduced (i.e., a RHS semantic), except placeholder symbols (e.g., entities, integer symbols).
	if (options.semantic && !semantic.isRHS(options.semantic) && !newRule.isPlaceholder) {
...
var nontermRuleOptionsSchema = {
	...
	// Specify this text object requiring conjugation, belonging to a descendant of this rule, needs to be conjugated to a grammatical case. E.g., "me" vs. "I".
	gramCase: { values: [ 'nom', 'obj' ], optional: true },
	// Specify this text object requiring conjugation, belonging to a descendant of this rule, needs to be conjugated to a grammatical case. E.g., "like" vs. "liked".
	verbForm: { values: [ 'past' ], optional: true },
	// Specify this text object requiring conjugation, belonging to a descendant of this rule, needs to be conjugated to a grammatical case. E.g., "like" vs "likes".
