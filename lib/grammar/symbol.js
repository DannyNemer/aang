...
var termRuleSchema = {
	...
	// The tense of this terminal symbol that is checked against the parent nonterminal rules' `acceptedTense` property to determine if this symbol is acceptable (though not enforced by default).
	tense: { values: [ 'past' ], optional: true },
}
...
var nontermRuleSchema = {
	...
	// The person-number for which to conjugate terminal rules either produced by this rule's RHS or which follow in a successive branch. E.g., "like" vs "likes".
	...
	acceptedTense: termRuleSchema.tense,
