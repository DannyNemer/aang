...
function NSymbol() {
	...
	NSymbol._NSymbols[this.name] = this
...
NSymbol.newBinaryRule = function (options, suppressDupWarning) {
	...
	// Create a new `NSymbol` and nonterminal (binary) rule.
...
function getExistingBinaryRuleLHSSym(symbolNameTokens, binaryRuleOptions) {
	...
	var existingNSymbol = NSymbol._NSymbols[symbolName]
