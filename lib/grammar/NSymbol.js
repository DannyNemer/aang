...
/**
 * Checks if `options`, which was passed to `NSymbol.prototype._newNonterminalRule()` or `NSymbol.newBinaryRule()`, is ill-formed. If so, prints an error.
 *
 * @private
 * @static
 * @param {Object} options The nonterminal rule options object to inspect.
