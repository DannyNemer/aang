...
var nontermRuleSchema = {
	// The array of `NSymbol`s, `NSymbol` names (strings), and/or nested arrays of RHS for new binary rules to recursively create. These sub-rules, however, can only contain a RHS and not other rule properties.
