...
NSymbol.newBinaryRule = function (options, suppressDupWarning) {
	...
	var existingBinaryRuleLHSSym = getExistingBinaryNSymbol(symbolNameTokens, options)
 ...
 */
function getExistingBinaryNSymbol(symbolNameTokens, binaryRuleOptions) {
	...
	// Check the `NSymbol` exists and was created by `NSymbol.newBinaryRule()`,
	if (existingNSymbol && existingNSymbol.isBinarySym) {
		/**
