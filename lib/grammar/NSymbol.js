...
NSymbol.newBinaryRule = function (options) {
	...
	// Recrusively create new binary rules for any nested arrays in the RHS. RHS can contain `NSymbol`s, `NSymbol` names (strings), and/or nested arrays of either for new binary rules to recursively create.
...
/**
 * Checks if the RHS symbols of `newRule` already exist for this (LHS) symbol.
 *
 * @memberOf NSymbol
 ...
 */
NSymbol.prototype.ruleRHSExists = function (newRule) {
