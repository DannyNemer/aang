 ...
 * • To distinguish binary symbols with identical `options.rhs` but differing properties, the new `NSymbol` `name` includes suffixes for the RHS symbol names to which `options.noInsertionIndexes` applies, if defined.
 *
...
NSymbol.newBinaryRule = function (options, suppressDupWarning) {
	 ...
	 *
	 * To distinguish binary symbols with identical `options.rhs` but differing properties, include suffixes for the RHS symbol names to which `options.noInsertionIndexes` applies, if defined.
	 */
	...
	// Mark `NSymbol` as for a binary rule, which prevents the addition of any more rules.
