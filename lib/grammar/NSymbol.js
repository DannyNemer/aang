...
var nontermRuleSchema = {
	 ...
	 * • nom - The nominative case, which conjugates pronouns used as the subject of a verb, created by
	 *         `g.newPronoun()` when . E.g., "I", "we".
	 * • obj - The objective case, which conjugates pronouns used as the object of a verb, created by
	 *         `g.newPronoun()`. E.g., "me", "us".
	 * • past - The simple past tense, which conjugates verbs created by `g.newVerb()`. E.g., "was", "liked",
	 *          "did", "had".
	 *
