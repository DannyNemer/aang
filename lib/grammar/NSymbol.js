...
/**
 * Checks if `rhs` produces no rules with conjugative `text` applicable to the non-person-number grammatical property, `gramProp`. Determines whether `gramProp` is useless on the rule that produces `rhs`, and therefore should be discarded.
 *
