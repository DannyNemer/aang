...
/**
 * Generates an array of `rhs` indexes for which to instruct `flattenTermSequence` to discard `text` the term sequence at each `rhs` index produces when creating a new terminal `ruleProps` for the associated nonterminal rule.
 *
 * Invoke this function after invoking `flattenNonterminalRHS(rhs)`.
 *
 * @private
