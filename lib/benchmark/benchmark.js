...
if (argTags.length > 0) {
	...
	util.log('Parsing test queries with the following tags:', argTags.map(util.unary(util.stylize)).join(', '))
}
...
// Complete CPU profile and print report to the Profiles panel (inside Chrome DevTools).
if (isDevtool) {
