 ...
 *   the 7-best parse trees but does not output the parse results.
 *
...
var argv = yargs
	.usage([
		...
		'  Benchmarks the duration of parsing the queries in the test suite. For each parse, finds the 7-best parse trees but does not output the parse results.',
		'',
