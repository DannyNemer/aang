...
/**
 * The base implementation of `dantil.pathAndLineNumbersOf` and `dantil.firstPathAndLineNumberOf` to find occurrences of `string` in the source file at `filePath`. Invokes iteratee per matched line with the path and line number in the format "path:line-number" as the only argument.
 *
 * @private
 * @param {string} filePath The path of the source file to search.
 * @param {string} string The string to search for.
