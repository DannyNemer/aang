 ...
 * @param {Function} func The function process while writing output to `path`.
...
/**
 * Pretty-prints the provided values and objects to `stdout`, in color, recursing 2 times while formatting objects (which is identical to `console.log()`).
 *
...
exports.dir = function () {
	process.stdout.write(format(arguments, { depth: null }) + '\n')
