 ...
 *   detail in 'ambiguityTests.js'. Many algorithms were created and ensured to catch all
...
var argv = yargs
	.usage([
		...
		'',
		'  This module was a massive undertaking. All cases of possible ambiguity are documented in detail in \'ambiguityTests.js\'. Many algorithms were created and ensured to catch all possible ambiguous cases. Several algorithms and unique data structures were developed and heuristics developed to make the construction of all possible paths and the comparison of paths as fast as possible. Many trials and errors. It was over 100 hours of work.',
	].join('\n'))
	.updateStrings({
...
require('../parser/initSemantics')(grammar)
