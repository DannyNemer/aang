...
function createPath(prevPath, rule) {
	...
	// Terminal rule.
		...
		if (nextItemList) {
			...
			// The path's grammatical properties (`verbForm`, `gramCase`, and `acceptedTense`) used to conjugate the second symbol of this binary rule, if applicable (i.e., a terminal rule).
