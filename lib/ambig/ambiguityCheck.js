...
function searchPaths(nontermSym) {
	...
	var rootPath = {
		...
		nextSym: undefined,
		// The linked list of the second symbols of previously incomplete binary rules and yet-to-conjugate text objects from insertion rules. After reaching a terminal symbol, inspect `nextItemList` to complete the binary rules and conjugate the text objects.
