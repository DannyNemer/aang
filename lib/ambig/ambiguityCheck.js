...
var argv = yargs
	.usage([
		...
		'',
		'  This module was a massive undertaking. All 32 cases of possible ambiguity are meticulously documented in detail in \'ambiguityTests.js\'. Many algorithms were created and ensured to catch all possible ambiguous cases. Several algorithms, unique data structures, and heuristics were developed to make the construction of all possible paths and the comparison of paths as fast as possible. Many trials and errors. It was well over 100 hours of arduous research and developement.',
	].join('\n'))
	.updateStrings({
