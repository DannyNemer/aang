								...
								if (!argv.findAll || !pairExists(ambigPairs, treeA, treeB)) {
									if (!argv.quiet) {
										...
										ambiguityToPrint.push({
											...
											semanticA: pathA.semanticTree === -1 ? -1 : (pathA.semanticTree ? semantic.colorString(semantic.toString(pathA.semanticTree)) : undefined),
											treeA: treeA,
											textB: pathB.textAndSyms,
											semanticB: pathB.semanticTree === -1 ? -1 : (pathB.semanticTree ? semantic.colorString(semantic.toString(pathB.semanticTree)) : undefined),
											treeB: treeB,
										})
									}
