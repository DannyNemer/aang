 ...
 *
 * Used by `ambiguityCheck` to test the coverage of its algorithm. When used, `ambiguityCheck` should print warnings for each of the following cases.
 */
