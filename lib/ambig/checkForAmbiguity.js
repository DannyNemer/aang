 ...
 * @param {number} prevNextSymsCount The number of `nextSyms` in the previous path. Used to determine if the rule of a LHS semantic has been completely reduced and that semantic can be reduced.
