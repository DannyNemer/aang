					...
					for (var o = 0; o < pathsBLen; ++o) {
						...
						if (pathB.nextSym === nextSym && listsEqual(pathB.nextSyms, nextSyms)) {
							...
							if (!argv.findAll || !pairExists(ambigPairs, treeA, treeB)) {
								...
								util.dir(pathA.semantics || 'No semantic', treeA)
								util.dir(pathB.semantics || 'No semantic', treeB)
 ...
 * @returns {Object} Returns the reduced semantics linked list if successfully parsed, else `-1`.
 */
