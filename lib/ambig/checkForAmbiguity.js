...
function createPath(prevPath, rule) {
	...
	if (!rule.isTerminal) {
		...
		newPath.semantics = appendSemantic(prevPath.semantics, prevPath.nextSymsCount, rule.semantic, rule.semanticIsRHS, rule.insertedSemantic)
 ...
 */
function appendSemantic(prevSemantic, prevNextSymsCount, newSemantic, semanticIsRHS, insertedSemantic) {
	// If `insertedSemantic` exists, then it is a RHS semantic and `newSemantic` also exists and is a LHS semantic.
	if (insertedSemantic) {
