...
var xDup = g.newSymbol(x.name, 'dup').addRule({ terminal: true, RHS: 'x' })
...
var xToY = g.newSymbol(x.name, 'to', y.name).addRule({ terminal: true, RHS: 'x', text: 'y' })
var xToYDup = g.newSymbol(x.name, 'to', y.name, 'dup').addRule({ terminal: true, RHS: 'x', text: 'y' })
var xyToX = g.newSymbol('xy', 'to', x.name).addRule({ terminal: true, RHS: 'x y', text: 'x' })
...
var xInsert = g.newSymbol(x.name, 'insert').addRule({ terminal: true, RHS: 'x', insertionCost: 0.5 })
var yInsert = g.newSymbol(y.name, 'insert').addRule({ terminal: true, RHS: 'y', insertionCost: 0.5 })
var xyTermInsert = g.newSymbol(xyTerm.name, 'insert').addRule({ terminal: true, RHS: 'x y', insertionCost: 0.5 })
