 ...
 *    `.archiveTestQuiet`, `.archiveGrammar`, `.archiveAmbigCheck`,
 *    `.archiveStateTable`, `.archiveAll`.
 *
 ...
 *    the same program. Includes: `.diffTest`, `.diffTestQuiet`, `.diffGrammar`,
 *    `.diffAmbigCheck`, `.diffStateTable`.
 *
...
var argv = yargs
	.usage([
		...
		'',
		'   • `.diff*` - Compares last archived output of program * to current output of the same program. Includes: `.diffTest`, `.diffTestQuiet`, `.diffGrammar`, `.diffAmbigCheck`, `.diffStateTable`.',
		'',
