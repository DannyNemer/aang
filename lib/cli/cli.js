...
rl.addCommands({
	...
	func: function archiveAll() {
		...
		rl.commands['.buildGrammar'](function () {
			// Copy `buildGrammar` output instead of invoking `archiveGrammar` to save 3.5 seconds. Write stream operation can be asynchorous because its output is not used here.
