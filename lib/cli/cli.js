...
rl.addCommands({
	...
	name: 'copyTest',
	description: 'Copy output of the test suite to the pasteboard.',
	...
	name: 'ambig',
	description: 'Find ambiguity in the grammar.',
	func: function ambig() {
		rl.spawnAsyncProcess('node', [
	...
	name: 'k',
	description: 'Set the maximum number of parse trees to find.',
	func: function k(k) {
	...
	func: function help() {
		util.log([
			...
			'  .ambig              find ambiguity in the grammar',
