...
rl.addCommands({
	...
	name: 'diffAmbigCheck',
	description: 'Compare the last archived ambiguity check output to the current ambiguity check output.',
	func: function diffAmbigCheck() {
		...
		rl.spawnAsyncProcess('node', [ '../ambig/ambiguityCheck.js' ], [ 'ignore', outFD, outFD ], function () {
	...
	name: 'diffStateTable',
	description: 'Compare the last archived state table to the current state table.',
	func: function diffStateTable() {
		...
		rl.spawnAsyncProcess('node', [ '../parse/printStateTable.js' ], [ 'ignore', outFD, outFD ], function () {
			// Invoke `vimdiff` to compare the current output to the last saved output.
