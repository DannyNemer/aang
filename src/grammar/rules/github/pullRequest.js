...
pullRequest.objFilter.addRule({ RHS: [ user.nomUsersPreVerbStopWordsHaveNoInsertion, github.created ], semantic: pullRequestsCreatedSemantic })
...
user.subjFilter.addRule({ RHS: [ github.haveNoInsertionCreated, pullRequest.catPl ], semantic: pullRequestCreatorsSemantic, personNumber: 'pl' })
